...
pub mod block_cipher_generic_test {
    ...
    pub const KEY_SCHEDULE_128: [u128; 11] = [
    ...
    pub const KEY_SCHEDULE_256: [u128; 15] = [
        u128::from_be(0x000102030405060708090a0b0c0d0e0f),
    ...
    pub fn test_key_schedule_128(expand: impl FnOnce(Aes128Key) -> [u128; 11]) {
    ...
    pub fn test_key_schedule_256(expand: impl FnOnce(Aes256Key) -> [u128; 15]) {
