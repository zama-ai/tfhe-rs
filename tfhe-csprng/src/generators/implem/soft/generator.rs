...
impl RandomGenerator for SoftwareRandomGenerator {
    ...
    fn new(params: impl Into<AesCtrParams>) -> Self {
        SoftwareRandomGenerator(AesCtrGenerator::from_params(params))
    }
...
mod test {
    ...
    use crate::generators::{generator_generic_test, Software128BlockCipher};
    ...
    mod fork_tests {
        use crate::generators::Software128BlockCipher;

        use super::*;

        #[test]
        fn prop_fork_first_state_table_index() {
            aes_ctr_generic_test::prop_fork_first_state_table_index::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork_last_bound_table_index() {
            aes_ctr_generic_test::prop_fork_last_bound_table_index::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork_parent_bound_table_index() {
            aes_ctr_generic_test::prop_fork_parent_bound_table_index::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork_parent_state_table_index() {
            aes_ctr_generic_test::prop_fork_parent_state_table_index::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork() {
            aes_ctr_generic_test::prop_fork::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork_with_parent_continuation() {
            aes_ctr_generic_test::prop_fork_with_parent_continuation::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork_children_remaining_bytes() {
            aes_ctr_generic_test::prop_fork_children_remaining_bytes::<Software128BlockCipher>();
        }

        #[test]
        fn prop_fork_parent_remaining_bytes() {
            aes_ctr_generic_test::prop_fork_parent_remaining_bytes::<Software128BlockCipher>();
        }
    ...
    fn test_conformance_with_ctr_crate() {
        aes_ctr_generic_test::test_conformance_with_ctr_crate::<Software128BlockCipher>();
    }

    #[test]
    fn test_forking_conformance_with_ctr_crate() {
        aes_ctr_generic_test::test_forking_conformance_with_ctr_crate::<Software128BlockCipher>();
    }
