...
const AES_128NUM_ROUNDS: usize = 10;
const AES_128_NUM_ROUND_KEYS: usize = AES_128NUM_ROUNDS + 1;

const AES_256NUM_ROUNDS: usize = 14;
const AES_256_NUM_ROUND_KEYS: usize = AES_256NUM_ROUNDS + 1;
...
unsafe fn aes_key_schedule<const S: usize, const R: usize>(
    ...
    let words =
        std::slice::from_raw_parts_mut(round_keys.as_mut_ptr() as *mut u32, R * num_words_in_key);
