...
pub fn crs_gen_ghl<G: Curve>(
    ...
    PublicParams {
        ...
        hash_R: core::array::from_fn(|_| rng.random()),
        ...
        hash_phi: core::array::from_fn(|_| rng.random()),
        hash_xi: core::array::from_fn(|_| rng.random()),
        hash_z: core::array::from_fn(|_| rng.random()),
        hash_chi: core::array::from_fn(|_| rng.random()),
    }
}
...
mod tests {
    ...
    fn test_pke() {
        ...
        let crs_k = k + 1 + (rng.random::<u32>() as usize % (d - k));
    ...
    impl PkeBoundTestcase {
        fn new(
            ...
            let tested_idx = match coeff_type {
                TestedCoeffType::E1 => rng.random::<u32>() as usize % d,
                TestedCoeffType::E2 => rng.random::<u32>() as usize % k,
            };
            ...
            match slack_mode {
                ...
                BoundTestSlackMode::Min => {
                    ...
                    testcase.e1 = (0..d)
                        .map(|_| if rng.random() { good_term } else { -good_term })
                        .collect();
                    testcase.e2 = (0..k)
                        .map(|_| if rng.random() { good_term } else { -good_term })
                        .collect();
    ...
    fn test_pke_bad_noise() {
        ...
        let bad_idx = rng.random::<u32>() as usize % d;
        let bad_term =
            (rng.random::<u64>() % (i64::MAX as u64 - B_with_slack_upper)) + B_with_slack_upper;
        ...
        let bad_idx = rng.random::<u32>() as usize % k;
    ...
    fn test_bad_ct() {
        ...
        let trivial = rng.random::<u64>() % effective_cleartext_t;
