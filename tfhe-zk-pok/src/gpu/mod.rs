...
// ---------------------------------------------------------------------------
// Compile-time assertions to verify layout compatibility between wrapper types and inner arkworks
// types. These ensure that G1Affine/G2Affine wrappers match size and alignment of their
// inner types for safe field-by-field conversion.
// ---------------------------------------------------------------------------
