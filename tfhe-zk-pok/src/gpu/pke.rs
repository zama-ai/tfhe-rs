...
//!
//! `prove` duplicates the logic of [`crate::proofs::pke::prove_impl`] but replaces every
//! `multi_mul_scalar` call with the GPU-accelerated [`super::g1_msm_gpu`]
//! / [`super::g2_msm_gpu`].  `verify` simply delegates to the CPU
...
// ---------------------------------------------------------------------------
// prove_impl – GPU variant of crate::proofs::pke::prove_impl
// ---------------------------------------------------------------------------
