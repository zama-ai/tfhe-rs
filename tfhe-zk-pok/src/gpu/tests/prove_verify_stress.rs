...
use crate::gpu::{pke as gpu_pke, pke_v2 as gpu_pke_v2};
    ...
    ) in cases
    {
        ...
        for load in [ComputeLoad::Proof, ComputeLoad::Verify] {
            ...
            let gpu_verify_result =
                gpu_pke::verify(&gpu_proof, (&public_param, &public_commit), verify_metadata);
            assert_eq!(
            ...
            // Although proofs are byte-identical, this exercises gpu_pke::verify
            ...
            let gpu_verify_cpu_proof =
                gpu_pke::verify(&cpu_proof, (&public_param, &public_commit), verify_metadata);
            assert_eq!(
