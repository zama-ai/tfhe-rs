...
// Projective point Montgomery conversion helpers
void g1_projective_from_montgomery_wrapper(G1ProjectivePoint* result, const G1ProjectivePoint* point);
void g2_projective_from_montgomery_wrapper(G2ProjectivePoint* result, const G2ProjectivePoint* point);
