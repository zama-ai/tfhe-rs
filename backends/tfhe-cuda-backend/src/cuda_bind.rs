...
extern "C" {
    ...
    pub fn scratch_cuda_generate_last_block_inner_propagation_kb_64_inplace(
        streams: *const *mut c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        op: i8,
    ...
    pub fn cuda_generate_last_block_inner_propagation_kb_64_inplace(
        streams: *const *mut c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        result: *mut c_void,
    ...
    pub fn cleanup_generate_last_block_inner_propagation(
        streams: *const *mut c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        mem_ptr: *mut *mut i8,
