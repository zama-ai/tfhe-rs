...
unsafe extern "C" {
    pub fn scratch_cuda_coexistent_cg_multi_bit_programmable_bootstrap_64_async(
        stream: *mut ffi::c_void,
        gpu_index: u32,
        pbs_buffer: *mut *mut i8,
        glwe_dimension: u32,
...
unsafe extern "C" {
    pub fn cleanup_cuda_coexistent_cg_multi_bit_programmable_bootstrap_64(
        stream: *mut ffi::c_void,
        gpu_index: u32,
        pbs_buffer: *mut *mut i8,
    );
...
unsafe extern "C" {
    pub fn cuda_coexistent_cg_multi_bit_programmable_bootstrap_lwe_ciphertext_vector_64_async(
        stream: *mut ffi::c_void,
        gpu_index: u32,
        lwe_array_out: *mut ffi::c_void,
        lwe_output_indexes: *const ffi::c_void,
