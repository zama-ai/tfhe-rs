...
unsafe extern "C" {
    #[link_name = "\u{1}_Z49scratch_cuda_programmable_bootstrap_128_vector_64PvjPPajjjjjbb"]
    pub fn scratch_cuda_programmable_bootstrap_128_vector_64(
        stream: *mut ffi::c_void,
        gpu_index: u32,
        pbs_buffer: *mut *mut i8,
        lwe_dimension: u32,
...
unsafe extern "C" {
    #[link_name = "\u{1}_Z62cuda_programmable_bootstrap_lwe_ciphertext_vector_128_input_64PvjS_PKvS1_S1_PK37CudaModulusSwitchNoiseReductionKeyFFIS1_Pajjjjjj"]
    pub fn cuda_programmable_bootstrap_lwe_ciphertext_vector_128_input_64(
        streams: *mut ffi::c_void,
        gpu_index: u32,
        lwe_array_out: *mut ffi::c_void,
        lut_vector: *const ffi::c_void,
        lwe_array_in: *const ffi::c_void,
