...
unsafe extern "C" {
    pub fn cuda_integer_aes_encrypt_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        state: *mut CudaRadixCiphertextFFI,
...
unsafe extern "C" {
    pub fn cleanup_cuda_integer_aes_encrypt_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        mem_ptr_void: *mut *mut i8,
...
unsafe extern "C" {
    pub fn cuda_integer_aes_mul_by_2_byte_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
...
unsafe extern "C" {
    pub fn cuda_integer_aes_mix_columns_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        col: *mut CudaRadixCiphertextFFI,
        mem_ptr: *mut i8,
        bsks: *const *mut ffi::c_void,
        ksks: *const *mut ffi::c_void,
        ms_noise_reduction_key: *const CudaModulusSwitchNoiseReductionKeyFFI,
