...
const _: () = {
    ...
    ["Offset of field: CudaPackedGlweCiphertextListFFI::lwe_bodies_count"]
        [::std::mem::offset_of!(CudaPackedGlweCiphertextListFFI, lwe_bodies_count) - 16usize];
