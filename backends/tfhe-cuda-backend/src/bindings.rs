...
unsafe extern "C" {
    pub fn cuda_prepare_count_of_consecutive_bits_buffer_kb_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        output: *mut CudaRadixCiphertextFFI,
...
unsafe extern "C" {
    pub fn scratch_cuda_count_of_consecutive_bits_buffer_kb_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        mem_ptr: *mut *mut i8,
...
unsafe extern "C" {
    pub fn cuda_count_of_consecutive_bits_buffer_kb_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        output: *mut CudaRadixCiphertextFFI,
...
unsafe extern "C" {
    pub fn cleanup_cuda_count_of_consecutive_bits_buffer_kb_64(
        streams: *const *mut ffi::c_void,
        gpu_indexes: *const u32,
        gpu_count: u32,
        mem_ptr: *mut *mut i8,
