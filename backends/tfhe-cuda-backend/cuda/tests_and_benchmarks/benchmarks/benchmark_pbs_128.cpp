...
// explicit entry point rather than the TFHE_RS_GPU_PBS128_RELAXED dispatcher,
// so the flavor under measurement is unambiguous, the way every other variant
// here is selected explicitly. Needs distributed shared memory and the
// noise-squashing shape, both covered by the support check.
