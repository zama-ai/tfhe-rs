...
template <typename Torus> struct int_sum_ciphertexts_vec_memory {
  ...
  int_sum_ciphertexts_vec_memory(cudaStream_t stream, uint32_t gpu_index,
    ...
    generate_device_accumulator<Torus>(
        stream, gpu_index, message_acc, glwe_dimension, polynomial_size,
        message_modulus, carry_modulus, lut_f_message);
    generate_device_accumulator<Torus>(
        stream, gpu_index, carry_acc, glwe_dimension, polynomial_size,
  ...
  int_sum_ciphertexts_vec_memory(cudaStream_t stream, uint32_t gpu_index,
    ...
    // create lut object for message and carry
    luts_message_carry = new int_radix_lut<Torus>(
        stream, gpu_index, params, 2, max_pbs_count, base_lut_object);
...
template <typename Torus> struct int_mul_memory {
  ...
  int_mul_memory(cudaStream_t stream, uint32_t gpu_index,
    ...
    sum_ciphertexts_mem = new int_sum_ciphertexts_vec_memory<Torus>(
        ...
        block_mul_res, vector_result_sb, small_lwe_vector, luts_array);
  }
