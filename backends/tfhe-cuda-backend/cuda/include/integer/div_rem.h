...
struct unsigned_int_div_rem_2_2_memory
{
                            ...
                            bool allocate_gpu_memory, uint64_t &size_tracker)
    {
        ...
        auto quotient_lut_3_f = [](Torus cond) -> Torus
        { return cond * 3; };
...
template <typename Torus>
struct unsigned_int_div_rem_memory
{
    int_radix_params params;
    ...
    int_goldschmidt_division_buffer<Torus> *div_rem_2_2_mem;
                                ...
                                uint64_t &size_tracker)
    {
        ...
        if (params.message_modulus == 4 && params.carry_modulus == 4)
        {
            ...
            // return;
            div_rem_2_2_mem = new int_goldschmidt_division_buffer<Torus>(
                streams, params, num_blocks, 9, allocate_gpu_memory, size_tracker);
            return;
        }
