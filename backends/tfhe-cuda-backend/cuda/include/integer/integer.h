...
void cuda_apply_univariate_lut_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *output_radix_lwe,
...
void cuda_full_propagation_64_inplace_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *input_blocks,
...
void cuda_integer_mult_inplace_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *radix_lwe_inout,
...
void cuda_negate_ciphertext_64(CudaStreamsFFI streams,
                               CudaRadixCiphertextFFI const *lwe_array_out,
                               CudaRadixCiphertextFFI const *lwe_array_in,
                               uint32_t message_modulus, uint32_t carry_modulus,
                               uint32_t num_radix_blocks);

void cuda_scalar_addition_ciphertext_64_inplace(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lwe_array,
...
void cuda_integer_comparison_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lwe_array_out,
...
void cuda_boolean_bitop_inplace_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lwe_array_inout,
    CudaRadixCiphertextFFI const *lwe_array_2, int8_t *mem_ptr,
    void *const *bsks, void *const *ksks);
...
void cuda_bitnot_ciphertext_64(CudaStreamsFFI streams,
                               CudaRadixCiphertextFFI const *radix_ciphertext,
...
void cuda_scalar_rotate_64_inplace_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lwe_array, uint32_t n,
    int8_t *mem_ptr, void *const *bsks, void *const *ksks);
...
void cuda_propagate_single_carry_64_inplace_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lwe_array,
    CudaRadixCiphertextFFI const *carry_out,
...
void cuda_add_and_propagate_single_carry_64_inplace_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lhs_array,
...
void cuda_integer_overflowing_sub_64_inplace_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *lhs_array,
    const CudaRadixCiphertextFFI *rhs_array,
    CudaRadixCiphertextFFI const *overflow_block,
...
void cuda_partial_sum_ciphertexts_vec_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *radix_lwe_out,
    CudaRadixCiphertextFFI const *radix_lwe_vec, int8_t *mem_ptr,
    void *const *bsks, void *const *ksks);
...
void cuda_integer_div_rem_64_async(CudaStreamsFFI streams,
                                   CudaRadixCiphertextFFI const *quotient,
                                   CudaRadixCiphertextFFI const *remainder,
...
void cuda_integer_abs_inplace_64_async(CudaStreamsFFI streams,
                                       CudaRadixCiphertextFFI const *ct,
...
void extend_radix_with_trivial_zero_blocks_msb_64(
    CudaRadixCiphertextFFI const *output, CudaRadixCiphertextFFI const *input,
    CudaStreamsFFI streams);

void trim_radix_blocks_lsb_64(CudaRadixCiphertextFFI const *output,
                              CudaRadixCiphertextFFI const *input,
                              CudaStreamsFFI streams);

void trim_radix_blocks_msb_64(CudaRadixCiphertextFFI const *output,
                              CudaRadixCiphertextFFI const *input,
                              CudaStreamsFFI streams);
...
void cuda_integer_unsigned_scalar_div_radix_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *numerator_ct,
    int8_t *mem_ptr, void *const *bsks, void *const *ksks,
...
void cuda_integer_unsigned_scalar_div_rem_radix_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *quotient_ct,
    CudaRadixCiphertextFFI const *remainder_ct, int8_t *mem_ptr,
    void *const *bsks, void *const *ksks,
    const CudaScalarDivisorFFI *scalar_divisor_ffi,
...
void cuda_integer_count_of_consecutive_bits_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *output_ct,
...
void cuda_cast_to_unsigned_64_async(CudaStreamsFFI streams,
                                    CudaRadixCiphertextFFI const *output,
                                    CudaRadixCiphertextFFI const *input,
...
void cuda_unchecked_index_in_clears_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *index_ct,
    CudaRadixCiphertextFFI const *match_ct, CudaRadixCiphertextFFI const *input,
...
void cuda_unchecked_first_index_of_clear_64_async(
    CudaStreamsFFI streams, CudaRadixCiphertextFFI const *index_ct,
    CudaRadixCiphertextFFI const *match_ct,
    VecCudaRadixCiphertextFFI const *inputs, const uint64_t *h_clear_val,
...
void cuda_unchecked_index_of_64_async(CudaStreamsFFI streams,
                                      CudaRadixCiphertextFFI const *index_ct,
                                      CudaRadixCiphertextFFI const *match_ct,
                                      VecCudaRadixCiphertextFFI const *inputs,
                                      CudaRadixCiphertextFFI const *value,
                                      uint32_t num_blocks,
