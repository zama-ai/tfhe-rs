...
void cleanup_cuda_full_propagation(CudaStreamsFFI streams, int8_t **mem_ptr_void);
...
void cleanup_cuda_integer_mult(CudaStreamsFFI streams,
                               int8_t **mem_ptr_void);
...
void cleanup_cuda_integer_comparison(CudaStreamsFFI streams, int8_t **mem_ptr_void);
...
void cleanup_cuda_integer_bitop(CudaStreamsFFI streams,
                                int8_t **mem_ptr_void);
...
void cleanup_cuda_integer_radix_cmux(CudaStreamsFFI streams, int8_t **mem_ptr_void);
