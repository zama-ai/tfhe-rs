...
template <typename Torus> struct int_radix_lut {
  ...
  // Broadcast luts from device streams.gpu_index(0) to all active gpus
...
template <typename Torus> struct unsigned_int_div_rem_2_2_memory {
  ...
  void init_lookup_tables(CudaStreams streams, uint32_t num_blocks,
    ...
    quotient_lut_1 = new int_radix_lut<Torus>(
        streams.subset(2), params, 1, 1, allocate_gpu_memory, size_tracker);
    quotient_lut_2 = new int_radix_lut<Torus>(
        streams.subset(1), params, 1, 1, allocate_gpu_memory, size_tracker);
  ...
  unsigned_int_div_rem_2_2_memory(CudaStreams streams, int_radix_params params,
    ...
    shift_mem = new int_logical_scalar_shift_buffer<Torus>(
        ...
        2 * num_blocks, allocate_gpu_memory, size_tracker);
  ...
  void scatter_indexes_for_overflowing_sub(
      cudaStream_t const stream, uint32_t gpu_index, Torus ***first_indexes_ptr,
