...
template <typename Torus> struct int_unsigned_scalar_div_mem {
  ...
  int_unsigned_scalar_div_mem(cudaStream_t const *streams,
                              ...
                              bool is_divisor_power_of_two,
                              bool log2_divisor_exceeds_threshold,
                              bool multiplier_exceeds_threshold,
                              uint32_t ilog2_divisor, uint64_t *size_tracker) {
    ...
    if (ilog2_divisor != (uint32_t)0) {
      if (is_divisor_power_of_two) {
        ...
        scalar_mul_high_mem = new int_scalar_mul_high<Torus>(
            streams, gpu_indexes, gpu_count, params, num_radix_blocks,
            allocate_gpu_memory, RIGHT_SHIFT, true, size_tracker);
        scp_mem = new int_sc_prop_memory<Torus>(
            streams, gpu_indexes, gpu_count, params, num_radix_blocks,
