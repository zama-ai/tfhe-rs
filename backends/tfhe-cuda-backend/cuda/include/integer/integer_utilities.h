...
template <typename Torus> struct int_unsigned_scalar_div_mem {
  ...
  int_unsigned_scalar_div_mem(cudaStream_t const *streams,
    ...
    if (!scalar_properties->is_abs_divisor_one) {
      if (scalar_properties->is_divisor_pow2) {
      ...
      } else if (scalar_properties->is_divisor_wider_than_numerator) {
        ...
        scalar_mul_high_mem = new int_scalar_mul_high_buffer<Torus>(
            streams, gpu_indexes, gpu_count, params, num_radix_blocks,
            scalar_properties->active_bits_multiplier, allocate_gpu_memory,
            size_tracker);
        scp_mem = new int_sc_prop_memory<Torus>(
            streams, gpu_indexes, gpu_count, params, num_radix_blocks,
...
template <typename Torus> struct int_signed_scalar_div_mem {
  ...
  int_signed_scalar_div_mem(cudaStream_t const *streams,
    ...
    if (!scalar_properties->is_multiplier_wider_than_numerator) {
      ...
      } else if (!scalar_properties->is_abs_divisor_one) {
  ...
  int_unsigned_scalar_div_rem_buffer(
    ...
    if (scalar_properties->is_divisor_pow2) {
      ...
      if (!scalar_properties->is_divisor_zero &&
          !scalar_properties->is_abs_divisor_one && num_radix_blocks != 0) {
        this->scalar_mul_mem = new int_scalar_mul_buffer<Torus>(
            streams, gpu_indexes, gpu_count, params, num_radix_blocks,
            scalar_properties->active_bits_divisor, allocate_gpu_memory, true,
            size_tracker);
      }
...
template <typename Torus> struct int_signed_scalar_div_rem_buffer {
  ...
  int_signed_scalar_div_rem_buffer(
    ...
    } else if (!scalar_properties->is_divisor_zero && !is_divisor_one &&
               num_radix_blocks != 0) {
      this->scalar_mul_mem = new int_scalar_mul_buffer<Torus>(
          streams, gpu_indexes, gpu_count, params, num_radix_blocks,
          scalar_properties->active_bits_divisor, allocate_gpu_memory, true,
