...
template <typename Torus> struct int_bitonic_shuffle_buffer {
  ...
  const CudaRadixCiphertext **padded_keys_ptrs;
  ...
  /// pointers.
  const CudaRadixCiphertext **padded_data_ptrs;
  ...
  int_bitonic_shuffle_buffer(CudaStreams streams, int_radix_params params,
    ...
    padded_keys_ptrs = new const CudaRadixCiphertext *[padded_num_values];
    ...
    padded_data_ptrs = new const CudaRadixCiphertext *[padded_num_values];
    for (uint32_t i = 0; i < num_sentinels; i++) {
...
template <typename Torus> struct int_oprf_bitonic_shuffle_buffer {
  ...
  /// key array.
  const CudaRadixCiphertext **keys_ptrs;
  ...
  int_oprf_bitonic_shuffle_buffer(CudaStreams streams, int_radix_params params,
    ...
    this->keys_ptrs = new const CudaRadixCiphertext *[num_values];
