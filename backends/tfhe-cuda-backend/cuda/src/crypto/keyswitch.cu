...
void cuda_keyswitch_lwe_ciphertext_vector_32_32(
  ...
  host_keyswitch_lwe_ciphertext_vector<uint32_t>(
      ...
      static_cast<uint32_t const *>(lwe_output_indexes),
      static_cast<uint32_t const *>(lwe_array_in),
      static_cast<uint32_t const *>(lwe_input_indexes),
      static_cast<uint32_t const *>(ksk), lwe_dimension_in, lwe_dimension_out,
