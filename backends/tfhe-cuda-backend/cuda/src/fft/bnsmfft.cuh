...
template <class params> __device__ void NSMFFT_direct_natural_order(double2 *A) {
...
template <class params> __device__ void NSMFFT_direct_registers(double2 data[params::opt], double2 *A) {
  ...
  Index tid = threadIdx.x;
  double2 *u = data, *v = &data[BUTTERFLY_DEPTH], w;
...
template <class params> __device__ void NSMFFT_inverse_registers(double2 data[params::opt], double2 *A) {
