...
void cuda_integer_aes_ctr_encrypt_64(
  ...
  host_integer_aes_ctr_encrypt<uint64_t>(
      ...
      plaintext_counter_bits, (int_aes_encrypt_buffer<uint64_t> *)mem_ptr, bsks,
...
void cuda_integer_aes_sbox_byte_64(
  ...
  aes_sbox_inplace<uint64_t>((cudaStream_t *)streams, gpu_indexes, gpu_count,
                             byte, mem, bsks, (uint64_t **)ksks,
                             ms_noise_reduction_key);
  aes_flush<uint64_t>((cudaStream_t *)streams, gpu_indexes, gpu_count, byte,
