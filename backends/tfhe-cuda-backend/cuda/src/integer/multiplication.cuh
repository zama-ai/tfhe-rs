...
__host__ void host_integer_partial_sum_ciphertexts_vec_async(
  ...
  if (num_radix_in_vec == 2) {
    ...
    as_radix_ciphertext_slice<Torus>(&terms_slice, terms, num_radix_blocks,
                                     2 * num_radix_blocks);
    host_addition_async<Torus>(streams.stream(0), streams.gpu_index(0), radix_lwe_out,
...
__host__ void host_integer_mult_radix_async(
  ...
  host_propagate_single_carry_async<Torus>(streams, radix_lwe_out, nullptr, nullptr,
