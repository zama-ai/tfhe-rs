...
uint64_t scratch_cuda_integer_grouped_oprf_u64(
  ...
  return scratch_cuda_integer_grouped_oprf<uint64_t>(
      ...
      (int_grouped_oprf_memory<uint64_t> **)mem_ptr, params, num_blocks,
      message_bits_per_block, total_random_bits, allocate_gpu_memory);
}

void cuda_integer_grouped_oprf_async_u64(
    void *const *streams, uint32_t const *gpu_indexes, uint32_t gpu_count,
...
void cleanup_cuda_integer_grouped_oprf_u64(void *const *streams,
