...
uint64_t scratch_cuda_sub_and_propagate_single_carry(
  ...
  *mem_ptr = new int_sub_and_propagate<Torus>(streams, params, num_radix_blocks, requested_flag,
...
void host_sub_and_propagate_single_carry(
  ...
  host_integer_radix_negation<Torus>(streams, mem->neg_rhs_array, rhs_array,
      mem->params.message_modulus, mem->params.carry_modulus,
      mem->neg_rhs_array->num_radix_blocks);

  host_add_and_propagate_single_carry<Torus>(streams, lhs_array, mem->neg_rhs_array, carry_out,
...
__host__ void host_integer_radix_subtraction(
  ...
  host_addition<Torus>(streams.stream(0), streams.gpu_index(0), lwe_array_out, lwe_array_out,
