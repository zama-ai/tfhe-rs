...
template <typename Torus>
__host__ void
host_kv_store_get_async(CudaStreams streams,
  ...
  host_zero_out_if_batch_async(streams, lwe_one_hot_vector, lwe_array_in_values,
...
__host__ void
host_kv_store_update_async(CudaStreams streams,
