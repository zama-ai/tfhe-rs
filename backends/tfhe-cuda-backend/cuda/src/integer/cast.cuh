...
__host__ void host_trim_radix_blocks_lsb(CudaRadixCiphertextFFI *output,
  ...
  copy_radix_ciphertext_slice_async<Torus>(
      streams.stream(0), streams.gpu_index(0), output, 0, output->num_radix_blocks, input,
...
__host__ uint64_t scratch_extend_radix_with_sign_msb(
  ...
  *mem_ptr = new int_extend_radix_with_sign_msb_buffer<Torus>(streams, params, num_radix_blocks,
