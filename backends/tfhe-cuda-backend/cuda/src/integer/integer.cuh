  ...
  if (num_groups > 1) {
    ...
    for (int i = 0; i < num_loops; i++) {
      ...
      host_radix_cumulative_sum_in_groups<Torus>(
          streams, gpu_indexes, group_resolved_carries, group_resolved_carries,
          blocks_to_solve + 1, big_lwe_size, mem->grouping_size);
...
void host_fast_propagate_single_carry(
  ...
  host_radix_sum_in_groups<Torus>(
      streams, gpu_indexes, prepared_blocks,
      mem->prop_simu_group_carries_mem->resolved_carries, prepared_blocks,
