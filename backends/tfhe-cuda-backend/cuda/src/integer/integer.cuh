 ...
 *   t                    0    1              2    3
 *
 * The three functions below are what the kernels and the host loops that
 * mirror degree and noise both read the network from, each call site asking
 * for the one position it needs.
 *
 * @param t index of the pair inside the level, targets only
 * @param half level width, half of the block a level combines
 * @return q-space start of the run t belongs to
 */
...
/** @brief The position that absorbs.
 *
 * @param t index of the pair inside the level
 ...
 * @return the position the level rewrites
 */
...
/** @brief The position it reads, one below the run and shared by all its
 * targets.
 *
 * @param t index of the pair inside the level
 * @param half level width
 ...
 * @return the position the level reads
 */
