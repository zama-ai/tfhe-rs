...
__host__ void integer_radix_apply_univariate_lookup_table_kb(
  ...
  if (active_gpu_count == 1) {
    ...
    multi_gpu_scatter_lwe_async<Torus>(
        ...
        lut->using_trivial_lwe_indexes, lut->non_trivial_setup,
        lut->lwe_aligned_vec, lut->active_gpu_count, num_radix_blocks,
        big_lwe_dimension + 1);
    POP_RANGE()
    ...
    multi_gpu_gather_lwe_async<Torus>(
        ...
        lut->non_trivial_setup, lut->lwe_aligned_vec, num_radix_blocks,
        big_lwe_dimension + 1);
    POP_RANGE()
...
__host__ void integer_radix_apply_noise_squashing_kb(
  ...
  if (active_gpu_count == 1) {
    ...
    multi_gpu_scatter_lwe_async<InputTorus>(
        ...
        lut->using_trivial_lwe_indexes, lut->non_trivial_setup,
        lut->lwe_aligned_scatter_vec, lut->active_gpu_count,
    ...
    multi_gpu_gather_lwe_async<__uint128_t>(
        ...
        lut->using_trivial_lwe_indexes, lut->non_trivial_setup,
        lut->lwe_aligned_gather_vec, lwe_array_out->num_radix_blocks,
        big_lwe_dimension + 1);
