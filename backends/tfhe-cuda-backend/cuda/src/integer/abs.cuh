...
template <typename Torus>
__host__ void host_integer_abs_async(CudaStreams streams, CudaRadixCiphertextFFI *ct,
  ...
  host_addition_async<Torus>(streams.stream(0), streams.gpu_index(0), ct, mask, ct,
  ...
  host_bitop_async<Torus>(streams, ct, mask, ct, mem_ptr->bitxor_mem, bsks, ksks);
}
