...
host_scalar_rotate_inplace_async(CudaStreams streams,
  ...
  if (mem->shift_type == LEFT_SHIFT) {
    ...
    host_radix_blocks_rotate_right_async<Torus>(streams, rotated_buffer, lwe_array,
    ...
    host_radix_blocks_rotate_right_async<Torus>(streams, giver_blocks, lwe_array, 1,
                                          num_blocks);
    ...
    host_radix_blocks_rotate_left_async<Torus>(streams, rotated_buffer, lwe_array,
                                         rotations, num_blocks);
    ...
    auto receiver_blocks = lwe_array;
    auto giver_blocks = rotated_buffer;
    host_radix_blocks_rotate_left_async<Torus>(streams, giver_blocks, lwe_array, 1,
                                         num_blocks);
