...
__host__ void host_integer_scalar_mul_radix(
    cudaStream_t const *streams, uint32_t const *gpu_indexes,
    uint32_t gpu_count, T *lwe_array, T *decomposed_scalar,
    T *has_at_least_one_set, int_scalar_mul_buffer<T> *mem, void *const *bsks,
    T *const *ksks, uint32_t input_lwe_dimension, uint32_t message_modulus,
