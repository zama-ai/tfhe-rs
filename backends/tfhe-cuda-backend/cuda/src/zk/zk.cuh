...
__host__ void host_expand_without_verification(
    ...
    const bool *is_boolean_array, zk_expand<Torus> *mem_ptr, KS_TYPE ks_type,
  ...
  auto d_compact_list_length_per_thread =
      mem_ptr->d_compact_list_length_per_thread;
  ...
  if (sizeof(Torus) == 8) {
    cuda_lwe_expand_64(streams[0], gpu_indexes[0], expanded_lwes,
                       ...
                       d_compact_list_length_per_thread,
...
__host__ void scratch_cuda_expand_without_verification(
    cudaStream_t const *streams, uint32_t const *gpu_indexes,
    uint32_t gpu_count, zk_expand<Torus> **mem_ptr,
    const uint32_t *num_samples_per_compact_list, const bool *is_boolean_array,
    uint32_t num_compact_lists, int_radix_params params,
    bool allocate_gpu_memory) {

  *mem_ptr = new zk_expand<Torus>(
      streams, gpu_indexes, gpu_count, params, num_samples_per_compact_list,
