...
void scratch_cuda_expand_without_verification_64(
  ...
  scratch_cuda_expand_without_verification<uint64_t>(
      ...
      reinterpret_cast<zk_expand<uint64_t> **>(mem_ptr),
      num_samples_per_compact_list, is_boolean_array, num_compact_lists, params,
      allocate_gpu_memory);
}
...
void cuda_expand_without_verification_64(
  ...
  host_expand_without_verification<uint64_t>(
      ...
      static_cast<const bool *>(NULL),
      reinterpret_cast<zk_expand<uint64_t> *>(mem_ptr), ks_type, bsks,
...
void cleanup_expand_without_verification_64(void *const *streams,
  ...
  zk_expand<uint64_t> *mem_ptr =
      reinterpret_cast<zk_expand<uint64_t> *>(*mem_ptr_void);
