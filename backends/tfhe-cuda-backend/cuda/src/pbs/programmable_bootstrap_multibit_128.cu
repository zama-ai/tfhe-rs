...
uint64_t scratch_cuda_multi_bit_programmable_bootstrap_128_vector_64(
  ...
  //
  //   bool supports_tbc =
  //       has_support_to_cuda_programmable_bootstrap_tbc_multi_bit<__uint128_t>(
  ...
  //     return scratch_cuda_tbc_multi_bit_programmable_bootstrap_128<uint64_t>(
  ...
  // #endif
  //     if (supports_cg)
  //   return scratch_cuda_cg_multi_bit_programmable_bootstrap_128<__uint128_t>(
  //       stream, gpu_index, (pbs_buffer_128<uint64_t, MULTI_BIT> **)buffer,
  //       glwe_dimension, polynomial_size, level_count,
  //       input_lwe_ciphertext_count, allocate_gpu_memory);
  // else
...
void cuda_multi_bit_programmable_bootstrap_lwe_ciphertext_vector_128(
  ...
  // #if CUDA_ARCH >= 900
  //     cuda_tbc_multi_bit_programmable_bootstrap_lwe_ciphertext_vector_128<uint64_t>(
  ...
  // #endif
  //   case PBS_VARIANT::CG:
  //     cuda_cg_multi_bit_programmable_bootstrap_lwe_ciphertext_vector_128<uint64_t>(
  //         stream, gpu_index, static_cast<__uint128_t *>(lwe_array_out),
  //         static_cast<const uint64_t *>(lwe_output_indexes),
  //         static_cast<const __uint128_t *>(lut_vector),
  //         static_cast<const uint64_t *>(lut_vector_indexes),
  ...
  cuda_multi_bit_programmable_bootstrap_lwe_ciphertext_vector_128<uint64_t>(
      ...
      static_cast<const uint64_t *>(lwe_input_indexes),
      static_cast<const __uint128_t *>(bootstrapping_key), buffer,
      lwe_dimension, glwe_dimension, polynomial_size, grouping_factor, base_log,
...
uint32_t get_lwe_chunk_size_128(uint32_t gpu_index, uint32_t max_num_pbs,
  ...
  if (max_shared_memory < full_sm_keybundle)
    cudaOccupancyMaxActiveBlocksPerMultiprocessor(
        &max_blocks_per_sm,
        device_multi_bit_programmable_bootstrap_keybundle_128<Torus, params, NOSM>,
