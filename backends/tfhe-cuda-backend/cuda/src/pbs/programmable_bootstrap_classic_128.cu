...
uint64_t scratch_cuda_programmable_bootstrap_128(
  ...
  return scratch_cuda_programmable_bootstrap_128_vector<__uint128_t>(
      stream, gpu_index,
      (pbs_buffer_128<__uint128_t, PBS_TYPE::CLASSICAL> **)pbs_buffer,
...
void cuda_programmable_bootstrap_lwe_ciphertext_vector_128(
  ...
  pbs_buffer_128<__uint128_t, PBS_TYPE::CLASSICAL> *buffer =
      (pbs_buffer_128<__uint128_t, PBS_TYPE::CLASSICAL> *)mem_ptr;
