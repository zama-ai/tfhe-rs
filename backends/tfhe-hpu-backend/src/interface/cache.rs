...
//!
//! Zhc required to upload optimized graph at runtime, those graph are store in hw and could be
//! reused This structure is here to kept track of the uploaded graph and manage the hw memory.
...
//! Fw memory is view a set of SLOT_SIZE_WORDS u32 slot to ease memory management and reduce
//! fragmentation.
