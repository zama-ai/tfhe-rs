...
pub const CONCRETE_BOOLEAN: HpuPBSParameters = HpuPBSParameters {
    ...
    glwe_noise_distribution: HpuNoiseDistributionInput::GaussianStdDev(0.0000000000000000000029403601535432533),
    pbs_base_log: 8,
    pbs_level: 2,
    ks_base_log: 5,
    ks_level: 4,
...
pub const MSG2_CARRY2_44B: HpuPBSParameters = HpuPBSParameters {
    ...
    glwe_dimension: 2,
    polynomial_size: 1024,
    lwe_noise_distribution: HpuNoiseDistributionInput::GaussianStdDev(1.259_780_968_897_627_7e-5_f64),
...
pub const MSG2_CARRY2_GAUSSIAN: HpuPBSParameters = HpuPBSParameters {
    ...
    glwe_dimension: 1,
    polynomial_size: 2048,
    lwe_noise_distribution: HpuNoiseDistributionInput::GaussianStdDev(3.553_990_235_944_282_5e-6_f64),
