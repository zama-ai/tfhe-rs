...
do for [k=1:1] {
    ...
    cmd_4 = "plot "
    do for [l=1:4] {
        cmd_4 = cmd_4."DATAFILE_BY_B u (($2 == N && $3 == k && $4 == ".l.") ? (y0=$7,x0=$5) : x0):(y0) w lp lt ".l." t 'measured l = ".l."', "
        cmd_4 = cmd_4."''   u (x0 = NaN):(y0 = NaN) notitle, "
        cmd_4 = cmd_4."''   u (($2 == N && $3 == k && $4 == ".l.") ? (y0=$6,x0=$5) : x0):(y0) w l  lt ".l." dt 3 t 'predicted l = ".l."', "
        cmd_4 = cmd_4."''   u (x0 = NaN):(y0 = NaN) notitle, "
    }
    evaluate(cmd_4)
    ...
    cmd_5 = "plot "
    do for [l=1:4] {
        cmd_5 = cmd_5."DATAFILE_BY_B u (($2 == N && $3 == k && $4 == ".l.") ? (y0=$7/$6,x0=$5) : x0):(y0) w lp lt ".l." t 'meas/pred l = ".l."', "
...
do for [logb=21:23] {
    ...
    cmd_2 = "plot "
    do for [lvl=1:3] {
        cmd_2 = cmd_2."DATAFILE_BY_N u (($5 == logb && $3 == k && $4 == ".lvl.") ? (y0=$7,x0=$2) : x0):(y0) w l  lt ".lvl." dt 3 t 'meas l = ".lvl."', "
        cmd_2 = cmd_2."''   u (x0 = NaN):(y0 = NaN) notitle, "
        cmd_2 = cmd_2."''   u (($5 == logb && $3 == k && $4 == ".lvl.") ? (y0=$6,x0=$2) : x0):(y0) w lp lt ".lvl." t 'pred l = ".lvl."', "
        cmd_2 = cmd_2."''   u (x0 = NaN):(y0 = NaN) notitle, "
    }
    evaluate(cmd_2)
