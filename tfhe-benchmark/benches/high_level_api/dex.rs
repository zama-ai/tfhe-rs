        ...
        + Sync,
{
    ...
    for num_elems in [10, 50, 100] {
        ...
        group.bench_with_input(&bench_id, &num_elems, |b, &num_elems| {
            ...
            b.iter(|| {
                let (sents_0, sents_1): (Vec<_>, Vec<_>) = from_balances_0
                    .iter()
                    .zip(from_balances_1.iter())
                    .zip(current_balances_0.iter())
                    .zip(current_balances_1.iter())
                    .zip(amount_0.iter())
                    .zip(amount_1.iter())
                    .map(|(((((from_0, from_1), curr_0), curr_1), amt_0), amt_1)| {
                        swap_request_update_dex_balance_func(
                            from_0, from_1, curr_0, curr_1, amt_0, amt_1,
                        )
                    })
                    .unzip();
                ...
                to_balances_0
                    ...
                    .for_each(
                        |(
                            (
                                (((to_balance_0, to_balance_1), total_token_0), total_token_1),
                                sent_0,
                            ),
                            sent_1,
                        )| {
                        ...
                        |(
                            ...
                            (
                                (
                                    (
                                        (
                                            (to_balances_0_gpu_i, to_balances_1_gpu_i),
                                ...
                                .for_each(
                                    |(
                                        (
                                            (
                                                (
                                                    (to_balances_0_chunk, to_balances_1_chunk),
                        ...
                        |(
                            (
                                (
                                    (
                                        (
                                            ((amount_0_out, amount_1_out), total_token_0_in),
                                            total_token_1_in,
                                        ),
                                        old_balance_0,
                                    ),
