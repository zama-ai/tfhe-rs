...
use benchmark_spec::{get_bench_type, BenchmarkSpec, BenchmarkType, HlapiOp, OperandType};
    ...
    FheType: FheWait + Send + Sync,
{
    ...
    let benchmark_spec = BenchmarkSpec::hlapi(
        hlapi_op,
        &param_name,
        &operand_type,
        Some(type_name),
...
macro_rules! generate_typed_benches {
    (
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: HlapiOp::OverflowingAdd,
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: HlapiOp::OverflowingMul,
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: HlapiOp::OverflowingSub,
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: HlapiOp::Sub,
            operation: sub
        );
        bench_type_ternary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::Flip,
            operation: flip
        );
        bench_type_ternary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::IfThenElse,
            operation: if_then_else
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::CheckedIlog2,
            operation: checked_ilog2
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::CountOnes,
            operation: count_ones
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::CountZeros,
            operation: count_zeros
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::Ilog2,
            operation: ilog2
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::IsEven,
            operation: is_even
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::IsOdd,
            operation: is_odd
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::LeadingOnes,
            operation: leading_ones
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::LeadingZeros,
            operation: leading_zeros
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::Neg,
            operation: neg
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::Not,
            operation: not
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::OverflowingNeg,
            operation: overflowing_neg
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::ReverseBits,
            operation: reverse_bits
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::TrailingOnes,
            operation: trailing_ones
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: HlapiOp::TrailingZeros,
