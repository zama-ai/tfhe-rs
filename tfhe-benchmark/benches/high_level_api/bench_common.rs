...
macro_rules! generate_typed_scalar_benches {
    (
        ...
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "add", operation: add, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "bitand", operation: bitand, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "bitor", operation: bitor, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "bitxor", operation: bitxor, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "div", operation: div, rng: || random_non_zero::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "eq", operation: eq, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "ge", operation: ge, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "gt", operation: gt, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "le", operation: le, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "lt", operation: lt, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "max", operation: max, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "min", operation: min, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "mul", operation: mul, rng: || random_not_power_of_two::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "ne", operation: ne, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "overflowing_add", operation: overflowing_add, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "overflowing_sub", operation: overflowing_sub, rng: || rand::random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "rem", operation: rem, rng: || random_non_zero::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "rotate_left", operation: rotate_left, rng: || rand::random::<$specific_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "rotate_right", operation: rotate_right, rng: || rand::random::<$specific_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "shift_left", operation: shl, rng: || <$specific_ty>::ONE);
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "shift_right", operation: shr, rng: || <$specific_ty>::ONE);
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "sub", operation: sub, rng: || rand::random::<$scalar_ty>());
    };
}
