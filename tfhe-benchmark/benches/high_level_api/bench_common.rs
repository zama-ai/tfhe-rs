...
use benchmark_spec::{get_bench_type, AtomicOp, BenchmarkSpec, BenchmarkType, OperandType};
...
macro_rules! generate_typed_benches {
    (
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: AtomicOp::OverflowingAdd,
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: AtomicOp::OverflowingMul,
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: AtomicOp::OverflowingSub,
        ...
        bench_type_binary_op!(
            ...
            left_type: $integer_type,
            right_type: $integer_type,
            hlapi_op: AtomicOp::Sub,
            operation: sub
        );
        bench_type_ternary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::Flip,
            operation: flip
        );
        bench_type_ternary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::IfThenElse,
            operation: if_then_else
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::CheckedIlog2,
            operation: checked_ilog2
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::CountOnes,
            operation: count_ones
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::CountZeros,
            operation: count_zeros
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::Ilog2,
            operation: ilog2
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::IsEven,
            operation: is_even
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::IsOdd,
            operation: is_odd
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::LeadingOnes,
            operation: leading_ones
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::LeadingZeros,
            operation: leading_zeros
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::Neg,
            operation: neg
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::Not,
            operation: not
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::OverflowingNeg,
            operation: overflowing_neg
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::ReverseBits,
            operation: reverse_bits
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::TrailingOnes,
            operation: trailing_ones
        );
        bench_type_unary_op!(
            type_name: $fhe_type,
            integer_type: $integer_type,
            hlapi_op: AtomicOp::TrailingZeros,
