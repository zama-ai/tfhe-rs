...
use benchmark::utilities::{write_to_json, OperandType, OperatorType};
...
macro_rules! generate_typed_scalar_benches {
    ($fhe_type:ident, $integer_type:ty, $scalar_ty:ty, $specific_ty:ty) => {
        ...
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "bitxor", operation: bitxor, rng: || random::<$scalar_ty>());
        ...
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "eq", operation: eq, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "ge", operation: ge, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "gt", operation: gt, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "le", operation: le, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "lt", operation: lt, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "max", operation: max, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "min", operation: min, rng: || random::<$scalar_ty>());
        ...
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "ne", operation: ne, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "overflowing_add", operation: overflowing_add, rng: || random::<$scalar_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "overflowing_sub", operation: overflowing_sub, rng: || random::<$scalar_ty>());
        ...
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "rotate_left", operation: rotate_left, rng: || random::<$specific_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "rotate_right", operation: rotate_right, rng: || random::<$specific_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "shift_left", operation: shl, rng: || get_one::<$specific_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $specific_ty, display_name: "shift_right", operation: shr, rng: || get_one::<$specific_ty>());
        bench_type_binary_scalar_op!(type_name: $fhe_type, integer_type: $integer_type, scalar_type: $scalar_ty, display_name: "sub", operation: sub, rng: || random::<$scalar_ty>());
    };
}
