...
mod cuda {
    ...
    use benchmark_spec::{
        bench_backend_from_cfg, get_bench_type, BenchCrate, BenchmarkSpec, BenchmarkType,
        CoreCryptoBench, CudaKeyswitchConfig, OperandType, TfheLayer,
    };
    use criterion::{black_box, Criterion, Throughput};
    use itertools::Itertools;
    use rayon::prelude::*;
        ...
        for (name, params) in parameters.iter() {
            ...
            match bench_type {
                BenchmarkType::Latency => {
                    ...
                    let benchmark_spec = BenchmarkSpec::new(
