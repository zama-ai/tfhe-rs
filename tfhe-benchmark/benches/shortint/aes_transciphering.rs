...
use benchmark_spec::tfhe::shortint::transciphering::{AesFlavor, Transciphering};
use benchmark_spec::{BenchmarkMetric, BenchmarkSpec, ShortintBench, TypeName};
...
pub fn cpu_aes_transciphering(c: &mut Criterion) {
    ...
    let benchmark_spec = BenchmarkSpec::<str>::new_shortint(
        ShortintBench::Transciphering(Transciphering::Aes(AesFlavor::KeyExpansion)),
        &param_name,
    ...
    let benchmark_spec = BenchmarkSpec::<str>::new_shortint(
        ShortintBench::Transciphering(Transciphering::Aes(AesFlavor::KeyExpansionPlus1Block)),
        &param_name,
        BenchmarkMetric::Latency,
    );
    bench_and_record(
    ...
    let benchmark_spec = BenchmarkSpec::<str>::new_shortint(
        ShortintBench::Transciphering(Transciphering::Aes(AesFlavor::Keystream1Block)),
        &param_name,
        BenchmarkMetric::Latency,
    );
    bench_and_record(
    ...
    let benchmark_spec = BenchmarkSpec::<str>::new_shortint(
        ShortintBench::Transciphering(Transciphering::Aes(AesFlavor::Keystream16Block)),
        &param_name,
        BenchmarkMetric::Latency,
    );
    bench_and_record(
    ...
    let benchmark_spec = BenchmarkSpec::<str>::new_shortint(
        ShortintBench::Transciphering(Transciphering::Aes(AesFlavor::Transcipher16Blocks)),
        &param_name,
        BenchmarkMetric::Latency,
    );
    bench_and_record(
