...
pub mod cuda {
    ...
    use benchmark_spec::tfhe::transciphering::trivium::TriviumFlavor;
    ...
    pub fn cuda_trivium(c: &mut Criterion) {
        ...
        for (atomic_param_val, param_name) in params {
            ...
            let init_spec = BenchmarkSpec::new_transciphering(
                TranscipheringBench::Trivium(TriviumFlavor::Init),
                &param_name,
                None,
            ...
            for num_steps in [64, 512] {
                ...
                let next_spec = BenchmarkSpec::new_transciphering(
                    TranscipheringBench::Trivium(TriviumFlavor::Next),
                    &param_name,
                    Some(PrecisionTag::Bits(num_steps).into()),
                    BenchmarkMetric::Latency,
                    None,
                );
                ...
                let gen_spec = BenchmarkSpec::new_transciphering(
                    TranscipheringBench::Trivium(TriviumFlavor::Generate),
                    &param_name,
                    Some(PrecisionTag::Bits(num_steps).into()),
                    BenchmarkMetric::Latency,
                    None,
