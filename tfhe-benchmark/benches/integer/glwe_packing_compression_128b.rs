...
mod cuda {
    ...
    fn get_num_elements_per_gpu(bit_size: usize) -> usize {
    ...
    fn execute_gpu_glwe_packing_128(c: &mut Criterion, config: BenchConfig) {
        ...
        match get_bench_type() {
            BenchmarkType::Latency => {
                ...
                bench_id_pack = format!("pack_u{bit_size}");
            ...
            BenchmarkType::Throughput => {
                ...
                bench_id_pack = format!("throughput::pack_u{bit_size}");
                bench_group.bench_function(&bench_id_pack, |b| {
                    b.iter(|| {
    ...
    fn execute_gpu_glwe_unpacking_128(c: &mut Criterion, config: BenchConfig) {
        ...
        match get_bench_type() {
            BenchmarkType::Latency => {
                ...
                bench_id_unpack = format!("unpack_u{bit_size}");
            ...
            BenchmarkType::Throughput => {
                ...
                bench_id_unpack = format!("throughput::unpack_u{bit_size}");
                bench_group.bench_function(&bench_id_unpack, |b| {
                    b.iter(|| {
