...
mod cuda {
    ...
    fn gpu_pke_zk_verify(c: &mut Criterion, results_file: &Path) {
        ...
        let (param_pke, param_ksk, param_fhe): (CompactPublicKeyEncryptionParameters, ShortintKeySwitchingParameters, tfhe::shortint::AtomicPatternParameters) = match get_param_type() {
            ParamType::Classical => {
