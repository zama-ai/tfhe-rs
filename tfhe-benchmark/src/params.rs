...
pub mod shortint_params {
    ...
    #[cfg(not(feature = "gpu"))]
    pub const SHORTINT_MULTI_BIT_BENCH_PARAMS: [MultiBitPBSParameters; 2] = [
        /*
    ...
    impl Default for ParamsAndNumBlocksIter {
        fn default() -> Self {
            ...
            if env_config.is_multi_bit {
                ...
                #[cfg(not(feature = "hpu"))]
                let params = vec![PARAM_MESSAGE_2_CARRY_2_KS32_PBS_GAUSSIAN_2M64.into(),
                                    PARAM_MESSAGE_2_CARRY_2_KS32_PBS_GAUSSIAN_2M128.into()];
