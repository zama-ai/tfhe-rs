...
mod integer_params {
    ...
    use tfhe::shortint::parameters::current_params::V1_1_HPU_PARAM_MESSAGE_2_CARRY_2_KS32_PBS_TUNIFORM_2M64;
        ...
        fn default() -> Self {
            ...
            if env_config.is_multi_bit {
                ...
                let params =
                    ...
                    vec![V1_1_HPU_PARAM_MESSAGE_2_CARRY_2_KS32_PBS_TUNIFORM_2M64.into()];
                #[cfg(not(feature = "hpu"))]
