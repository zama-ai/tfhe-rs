...
fn tuniform_key_set_sizes(results_file: &Path) {
    ...
    let param_pke_name = BENCH_PARAM_PKE_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128.name();
    ...
    let param_compression_name = BENCH_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128.name();
    let params_tuple = (
        param_compression,
    ...
    let param_casting_name = BENCH_PARAM_KEYSWITCH_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128.name();
