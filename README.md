...
This allows users to reproduce the experiment results presented in **Table 3** and **Table 4**.
The implementation has been integrated into the **TFHE-rs** library, version 1.3.0. 
...
Tested on Linux and Mac OS with Rust version >= 1.85 (see [here](https://www.rust-lang.org/tools/install) a guide to install Rust).
