...
test_web_js_api_parallel_chrome: server_cmd = "npm run server:multithread"
...
test_web_js_api_parallel_firefox: server_cmd = "npm run server:multithread"
...
bench_web_js_api_parallel_chrome: server_cmd = "npm run server:multithread"
...
bench_web_js_api_parallel_firefox: server_cmd = "npm run server:multithread"
