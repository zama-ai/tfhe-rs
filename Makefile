...
CARGO_LOCK_DIRS = . apps/trivium utils/tfhe-lints $(BACKWARD_COMPAT_DATA_DIR) \
	$(addprefix $(BACKWARD_COMPAT_DATA_DIR)/crates/,$(shell ls -1 $(BACKWARD_COMPAT_DATA_DIR)/crates/ | grep generate_))
