...
pub fn load_params(test_params: &TestParameterSet) -> ClassicPBSParameters {
    ...
    let modulus_switch_noise_reduction_params = match modulus_switch_noise_reduction_params {
        ...
        TestModulusSwitchType::DriftTechniqueNoiseReduction(TestModulusSwitchNoiseReductionParams {
        ...
        TestModulusSwitchType::CenteredMeanNoiseReduction => ModulusSwitchType::CenteredMeanNoiseReduction,
    };
