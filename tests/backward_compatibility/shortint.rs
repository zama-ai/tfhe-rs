...
pub fn load_params(test_params: &TestParameterSet) -> ClassicPBSParameters {
    ...
    let modulus_switch_noise_reduction_params = match modulus_switch_noise_reduction_params {
        TestModulusSwitchType::Plain => ModulusSwitchType::Plain,
        TestModulusSwitchType::PlainAddZero(TestModulusSwitchNoiseReductionParams {
            modulus_switch_zeros_count,
            ms_bound,
            ms_r_sigma_factor,
            ms_input_variance,
        }) => ModulusSwitchType::PlainAddZero(ModulusSwitchNoiseReductionParams {
        ...
        TestModulusSwitchType::Centered => ModulusSwitchType::Centered,
    };
