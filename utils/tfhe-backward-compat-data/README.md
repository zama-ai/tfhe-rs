...
## Using the test data
The data is stored using git-lfs, so be sure to clone this project with lfs first. Since the lfs data are not cloned by default, you need to clone them before:
```
