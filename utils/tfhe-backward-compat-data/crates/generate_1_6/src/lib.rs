...
const HL_SEEDED_PROVEN_COMPACT_LIST_TEST: HlSeededCompactCiphertextListTest =
    HlSeededCompactCiphertextListTest {
        ...
        proof_info: Some(ZkProofAuxiliaryInfo {
...
impl TfhersVersion for V1_6 {
    ...
    fn gen_hl_data<P: AsRef<Path>>(base_data_dir: P) -> Vec<TestMetadata> {
        ...
        vec![
            ...
            TestMetadata::HlSeededCompactCiphertextList(HL_SEEDED_PROVEN_COMPACT_LIST_TEST),
        ]
    }
}
