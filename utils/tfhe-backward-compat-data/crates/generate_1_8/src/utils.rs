...
impl ConvertParams<TranscipheringParameters> for TestTranscipheringParameters {
...
impl ConvertParams<MetaParameters> for TestMetaParameters {
    fn convert(self) -> MetaParameters {
        MetaParameters {
            ...
            transciphering_parameters: self.transciphering_parameters.map(ConvertParams::convert),
        }
    }
}
