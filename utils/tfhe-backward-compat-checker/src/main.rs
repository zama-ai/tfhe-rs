...
/// Run the backward compatibility check between base and head snapshots.
/// Exit codes: 0 = pass, 1 = breaking errors detected, 2 = new enums not allowed (regenerate base).
