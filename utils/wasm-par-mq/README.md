...
Sync mode uses a Service Worker to coordinate blocking XHR. You need to copy this file
at a location whose scope covers your page. The scope defaults to the directory where
