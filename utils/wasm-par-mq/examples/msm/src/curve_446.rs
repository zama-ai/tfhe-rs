//! Implementation of the BLS12-446 curve for arkworks api. See: https://std.neuromancer.sk/bls/BLS12-446.
...
pub mod g1 {
    ...
    impl SWCurveConfig for Config {
        ...
        /// Substituting (0, 0) into the curve equation gives 0 = b.
        /// Since b (defined as COEFF_B) is not 0, it means that the point (0, 0) is not on the
        /// curve. Therefore, we can safely use (0, 0) as a flag for the zero point.
        ///
        /// See: <https://docs.rs/ark-ec/latest/ark_ec/models/short_weierstrass/trait.SWCurveConfig.html#associatedtype.ZeroFlag>
        type ZeroFlag = ();
