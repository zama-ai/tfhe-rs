...
use tfhe::{
    generate_keys, CompactFheUint8, CompactFheUint8List, CompactFheUint8ConformanceParams,
...
fn main() {
    ...
    let conformance_params_1 = CompactFheUint8ConformanceParams::from(params_1);
    let conformance_params_2 = CompactFheUint8ConformanceParams::from(params_2);
