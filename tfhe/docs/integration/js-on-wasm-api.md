...
We publish multiple wasm packages. They differ in two ways: the runtime they target, and how much of the API they include.
...
function fhe_uint32_example() {
  ...
  const block_params = new ShortintParameters(ShortintParametersName.V1_7_PARAM_MESSAGE_2_CARRY_2_COMPACT_PK_PBS_KS_GAUSSIAN_2M64);
