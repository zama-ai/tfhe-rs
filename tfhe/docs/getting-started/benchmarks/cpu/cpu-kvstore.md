...
The next table shows the operation timings on CPU to replace the value corresponding to an encrypted key, with the result of applying a function to the current value.
