...
pub fn main() {
    ...
    let (cks, sks) = generate_keys(V1_9_META_PARAM_CPU_2_2_KS_PBS_PKE_TO_SMALL_ZKV2_TUNIFORM_2M128);
...
pub fn main() {
    let cks = ClientKey::generate(V1_9_META_PARAM_CPU_2_2_KS_PBS_PKE_TO_SMALL_ZKV2_TUNIFORM_2M128);
...
pub fn main() {
    let config = Config::from(V1_9_META_PARAM_CPU_2_2_KS_PBS_PKE_TO_SMALL_ZKV2_TUNIFORM_2M128);
...
pub fn main() {
    ...
    for params in [
        ...
        V1_9_META_PARAM_CPU_2_2_KS_PBS_PKE_TO_SMALL_ZKV2_TUNIFORM_2M128,
    ] {
