...
Providing a `max_distance` can give better performance at the cost of a distribution further from the uniform. Look at the documentation of the method for more details.
