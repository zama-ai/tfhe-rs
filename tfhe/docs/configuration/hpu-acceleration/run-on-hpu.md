...
fn main() {
    ...
    let hpu_device = HpuDevice::from_config(ShellString::new("${HPU_BACKEND_DIR}/config_store/${HPU_CONFIG}/hpu_config.toml".to_string()).expand().as_str(), false, &tfhe::core_crypto::hpu::create_hpu_lookuptable,
    )
