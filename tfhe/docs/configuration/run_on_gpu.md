...
| Rotate right/left                 | `rotate_right`        | :heavy\_check\_mark:       | :heavy\_check\_mark:       |
...
To go further, you can check our [tutorial](../tutorials/multi_gpu_device_selection.md) on how to 
maximize throughput on multiple GPUs with TFHE-rs.
