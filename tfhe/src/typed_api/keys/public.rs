...
#[cfg(feature = "boolean")]
use crate::typed_api::booleans::{BooleanCompressedPublicKey, BooleanPublicKey};
use crate::typed_api::errors::{UninitializedPublicKey, UnwrapResultExt};
#[cfg(feature = "integer")]
use crate::typed_api::integers::{IntegerCompressedPublicKey, IntegerPublicKey};
#[cfg(feature = "shortint")]
use crate::typed_api::shortints::{ShortIntCompressedPublicKey, ShortIntPublicKey};
...
macro_rules! impl_ref_key_from_compressed_public_keychain {
    (
        ...
        impl crate::typed_api::keys::RefKeyFromCompressedPublicKeyChain for $implementor {
            type Key = $key_type;

            fn ref_key(self, keys: &crate::typed_api::keys::CompressedPublicKey)
                -> Result<&Self::Key, crate::typed_api::errors::UninitializedPublicKey>
            {
                keys$(.$member)*
                    .as_ref()
                    .ok_or(crate::typed_api::errors::UninitializedPublicKey($enum_variant))
