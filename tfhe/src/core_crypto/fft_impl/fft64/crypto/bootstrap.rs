...
use crate::core_crypto::prelude::{
    switch_lwe_modulus, CiphertextCount, CiphertextModulus, ContainerMut, ModulusSwitchedCt,
};
...
impl FourierLweBootstrapKeyView<'_> {
        ...
        OutputScalar: UnsignedTorus,
    {
        ...
        for (lwe_mask_element, bootstrap_key_ggsw) in izip!(lwe_mask, self.into_ggsw_iter()) {
        ...
        OutputScalar: UnsignedTorus,
    {
        ...
        let msed = switch_lwe_modulus(lwe_in.as_view(), log_modulus);
        ...
        OutputScalar: UnsignedTorus,
    {
        ...
        let lwe_in_msed: Vec<_> = lwes_in
            .iter()
            .map(|lwe_in| switch_lwe_modulus(lwe_in, log_modulus))
            .collect();
