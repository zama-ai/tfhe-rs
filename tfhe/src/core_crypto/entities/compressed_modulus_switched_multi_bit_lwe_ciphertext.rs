...
use entities::compressed_modulus_switched_multi_bit_lwe_ciphertext::CompressedModulusSwitchedMultiBitLweCiphertextVersions;
...
> {
    pub(in crate::core_crypto) body: PackingScalar,
    pub(in crate::core_crypto) packed_mask: PackedIntegers<PackingScalar>,
    pub(in crate::core_crypto) packed_diffs: Option<PackedIntegers<PackingScalar>>,
    pub(in crate::core_crypto) lwe_dimension: LweDimension,
    pub(in crate::core_crypto) uncompressed_ciphertext_modulus: CiphertextModulus<PackingScalar>,
    pub(in crate::core_crypto) grouping_factor: LweBskGroupingFactor,
}
