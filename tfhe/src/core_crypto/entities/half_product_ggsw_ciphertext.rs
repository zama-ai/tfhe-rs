...
/// decomposition parameters. The half-product variant lets the
/// last GLev — the one multiplied by the body of the input GLWE during the external product — use
/// its own, typically lighter, decomposition parameters:
///
