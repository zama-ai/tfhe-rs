...
use super::cm_glwe_ciphertext::{
    cm_glwe_ciphertext_encryption_mask_sample_count,
    cm_glwe_ciphertext_encryption_noise_sample_count,
};
...
use crate::core_crypto::prelude::{PolynomialListMutView, PolynomialListView};
...
pub fn cm_ggsw_level_matrix_encryption_noise_sample_count(
    ...
    (glwe_dimension.0 + cm_dimension.0)
        * cm_glwe_ciphertext_encryption_noise_sample_count(cm_dimension, polynomial_size)
}
