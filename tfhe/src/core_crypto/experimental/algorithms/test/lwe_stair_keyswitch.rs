...
>(
    ...
    let std_dev_bsk = params.bsk_glwe_noise_distribution;
    let lwe_dimension = params.lwe_dimension;
    let ks1_lwe_noise_distribution = params.ks1_lwe_noise_distribution;
    let ks2_lwe_noise_distribution = params.ks2_lwe_noise_distribution;
