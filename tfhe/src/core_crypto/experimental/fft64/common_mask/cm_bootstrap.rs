...
use crate::core_crypto::commons::parameters::{
    DecompositionBaseLog, DecompositionLevelCount, GlweDimension, LweDimension, MonomialDegree,
    PolynomialSize,
};
...
use crate::core_crypto::experimental::fft64::common_mask::cm_ggsw::cm_add_external_product_assign;
...
pub fn cm_bootstrap_scratch<Scalar>(
    ...
    blind_rotate_scratch::<Scalar>(glwe_dimension, cm_dimension, polynomial_size, fft).and(
        StackReq::new_aligned::<Scalar>(
            (glwe_dimension.0 + cm_dimension.0) * polynomial_size.0,
            CACHELINE_ALIGN,
        ),
