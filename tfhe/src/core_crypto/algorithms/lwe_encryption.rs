...
fn encrypt_lwe_compact_ciphertext_list_with_compact_public_key_impl<
    const USE_OPTIMIZED_BINARY_CONVOLUTION: bool,
    Scalar,
    KeyCont,
    InputCont,
    OutputCont,
    ...
    output_mask_list
        ...
        .for_each(
            |(
                ...
                if USE_OPTIMIZED_BINARY_CONVOLUTION {
    ...
    EncryptionGen: ByteRandomGenerator,
{
    let _ = encrypt_lwe_compact_ciphertext_list_with_compact_public_key_impl::<
        false, /* We don't use the optimized variant for encryption by default because it can
...
pub mod re_randomization {
    ...
    {
        let _ = encrypt_lwe_compact_ciphertext_list_with_compact_public_key_impl::<
            true, /* We use the optimized variant for rerand, timing attacks are not relevant in
                   * this case */
            _,
            _,
            _,
