...
pub fn measure_noise_estimation_for_binary_key<Scalar: UnsignedInteger>(
    ...
    C2: Container<Element = Scalar>,
{
    ...
    let base_measure = measure_noise_estimation_for_binary_key(
        r_sigma_factor,
        log_modulus,
        mask.iter().copied(),
        *lwe.get_body().data,
...
/// introduced by the subsequent modulus switch
///
/// Technique is descibed at https://eprint.iacr.org/2024/1718.pdf
