...
fn lwe_encrypt_decrypt_noise_distribution_custom_mod<Scalar: UnsignedTorus + CastInto<usize>>(
    ...
    let expected_variance = lwe_noise_distribution.gaussian_std_dev();
...
>(
    ...
    let glwe_variance = glwe_noise_distribution.gaussian_std_dev();
...
fn random_noise_roundtrip<Scalar: UnsignedTorus + CastInto<usize>>(
    ...
    let expected_variance = noise.gaussian_std_dev();
