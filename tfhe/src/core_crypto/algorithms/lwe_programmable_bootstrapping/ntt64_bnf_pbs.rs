...
use crate::core_crypto::prelude::{switch_lwe_modulus, ModulusSwitchedCt};
    ...
    KeyCont: Container<Element = u64>,
{
    fn implementation(
        ...
        for (lwe_mask_element, bootstrap_key_ggsw) in izip!(lwe_mask, bsk.into_ggsw_iter()) {
    ...
    implementation(bsk.as_view(), lut.as_mut_view(), input, ntt, stack);
}
    ...
    KeyCont: Container<Element = u64>,
{
    fn implementation(
        ...
        let lwe_in_msed = switch_lwe_modulus(lwe_in, log_modulus);
