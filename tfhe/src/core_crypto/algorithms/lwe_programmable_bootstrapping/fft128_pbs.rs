...
/// );
///
/// let lwe_ciphertext_in_msed =
///     lwe_ciphertext_modulus_switch(lwe_ciphertext_in.as_view(), log_modulus);
///
/// let mut buffers = ComputationBuffers::new();
///
/// let fft = Fft128::new(fourier_bsk.polynomial_size());
...
use crate::core_crypto::commons::noise_formulas::traits::LweStandardFft128Bootstrap;
