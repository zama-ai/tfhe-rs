...
use crate::core_crypto::fft_impl::fft64::crypto::cm_bootstrap::FourierCmLweBootstrapKey;
...
/// Memory optimized version of [`convert_standard_cm_lwe_bootstrap_key_to_fourier`].
