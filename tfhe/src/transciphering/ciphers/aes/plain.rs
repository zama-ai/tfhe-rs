...
use tfhe_csprng::generators::default::DefaultBlockCipher128;
...
impl AesPlainState {
    pub fn new(key: impl Into<AesPlainKey>, iv: impl Into<AesIv>) -> Self {
        Self {
            cipher: DefaultBlockCipher128::new(Aes128Key::new(key.into().to_csprng_key_u128())),
            iv: iv.into(),
            counter: 0,
        }
    }
