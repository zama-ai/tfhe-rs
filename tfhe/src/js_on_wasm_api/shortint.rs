...
impl Shortint {
    ...
    pub fn get_parameters(
        ...
        match (message_bits, carry_bits) {
            (1, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (2, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_2_KS_PBS_GAUSSIAN_2M64),
            (2, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (3, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 3) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_3_KS_PBS_GAUSSIAN_2M64),
            (2, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M64),
            (3, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (4, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_4_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 4) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_4_KS_PBS_GAUSSIAN_2M64),
            (2, 3) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_3_KS_PBS_GAUSSIAN_2M64),
            (3, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_2_KS_PBS_GAUSSIAN_2M64),
            (4, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_4_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (5, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_5_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 5) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_5_KS_PBS_GAUSSIAN_2M64),
            (2, 4) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_4_KS_PBS_GAUSSIAN_2M64),
            (3, 3) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_3_KS_PBS_GAUSSIAN_2M64),
            (4, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_4_CARRY_2_KS_PBS_GAUSSIAN_2M64),
            (5, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_5_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (6, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_6_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 6) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_6_KS_PBS_GAUSSIAN_2M64),
            (2, 5) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_5_KS_PBS_GAUSSIAN_2M64),
            (3, 4) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_4_KS_PBS_GAUSSIAN_2M64),
            (4, 3) => Ok(crate::shortint::parameters::PARAM_MESSAGE_4_CARRY_3_KS_PBS_GAUSSIAN_2M64),
            (5, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_5_CARRY_2_KS_PBS_GAUSSIAN_2M64),
            (6, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_6_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (7, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_7_CARRY_0_KS_PBS_GAUSSIAN_2M64),
            (1, 7) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_7_KS_PBS_GAUSSIAN_2M64),
            (2, 6) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_6_KS_PBS_GAUSSIAN_2M64),
            (3, 5) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_5_KS_PBS_GAUSSIAN_2M64),
            (4, 4) => Ok(crate::shortint::parameters::PARAM_MESSAGE_4_CARRY_4_KS_PBS_GAUSSIAN_2M64),
            (5, 3) => Ok(crate::shortint::parameters::PARAM_MESSAGE_5_CARRY_3_KS_PBS_GAUSSIAN_2M64),
            (6, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_6_CARRY_2_KS_PBS_GAUSSIAN_2M64),
            (7, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_7_CARRY_1_KS_PBS_GAUSSIAN_2M64),
            (8, 0) => Ok(crate::shortint::parameters::PARAM_MESSAGE_8_CARRY_0_KS_PBS_GAUSSIAN_2M64),
    ...
    pub fn get_parameters_small(
        ...
        set_hook(Box::new(console_error_panic_hook::hook));
        match (message_bits, carry_bits) {
            (1, 1) => Ok(crate::shortint::parameters::PARAM_MESSAGE_1_CARRY_1_PBS_KS_GAUSSIAN_2M64),
            (2, 2) => Ok(crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_PBS_KS_GAUSSIAN_2M64),
            (3, 3) => Ok(crate::shortint::parameters::PARAM_MESSAGE_3_CARRY_3_PBS_KS_GAUSSIAN_2M64),
            (4, 4) => Ok(crate::shortint::parameters::PARAM_MESSAGE_4_CARRY_4_PBS_KS_GAUSSIAN_2M64),
            _ => Err(wasm_bindgen::JsError::new(
                format!(
                "No parameters for {message_bits} bits of message and {carry_bits} bits of carry"
            )
