    ...
    (
        ...
        impl $type_name {
            ...
            pub fn encrypt_with_client_key(
                value: JsValue,
                client_key: &crate::js_on_wasm_api::js_high_level_api::client::TfheClientKey,
