...
use crate::integer::gpu::ciphertext::expand_async;
...
impl CudaProvenCompactCiphertextList {
    ...
    pub fn verify_and_expand(
        ...
        let (not_all_valid, r) = rayon::join(
            || {
                self.h_proved_lists
                    .ct_list
                    .proved_lists
    ...
    pub fn expand_without_verification(
        ...
        let (expanded_blocks, blocks_info) =
            unsafe { self.expand_without_verification_async(key, streams)? };
        streams.synchronize();
    ...
    pub unsafe fn expand_without_verification_async(
        ...
        CudaLweCiphertextList<u64>,
        Vec<CudaCompactCiphertextListInfo>,
    )> {
...
mod tests {
    ...
    use crate::integer::{ClientKey, CompactPrivateKey, CompactPublicKey, CompressedServerKey};
    use crate::shortint::parameters::{
        PARAM_KEYSWITCH_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        PARAM_PKE_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    };
    use crate::zk::gpu::CudaProvenCompactCiphertextList;
