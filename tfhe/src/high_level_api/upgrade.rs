...
mod tests {
    ...
    use crate::prelude::*;
    #[cfg(feature = "gpu")]
    use crate::shortint::parameters::current_params::V1_2_COMP_PARAM_GPU_MULTI_BIT_GROUP_4_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128;
    #[cfg(feature = "gpu")]
    use crate::shortint::parameters::current_params::V1_2_PARAM_GPU_MULTI_BIT_GROUP_4_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128;
