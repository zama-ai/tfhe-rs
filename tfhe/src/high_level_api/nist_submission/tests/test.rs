...
use crate::nist_submission::parameters::NIST_META_PARAMS_2_2;
#[cfg(feature = "zk-pok")]
use crate::nist_submission::parameters::NIST_PARAM_PKE_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128;
use crate::nist_submission::{
    preproc_eval, set_server_key, ClientKey, CompactPublicKey, CompressedXofKeySet, Config,
    FheUint32, NormalizedHammingWeightBound, SquashedNoiseFheUint, Tag,
};
#[cfg(feature = "zk-pok")]
use crate::nist_submission::{
    CompactCiphertextListBuilder, CompactPkeCrs, ProvenCompactCiphertextList, ZkComputeLoad,
};
...
fn complete_test_zk() {
    ...
    builder.push(clear_a).push(clear_b).push(clear_c);
    let proven_list: ProvenCompactCiphertextList = builder
