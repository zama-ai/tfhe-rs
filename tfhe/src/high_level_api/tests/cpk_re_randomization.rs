...
mod gpu {
    ...
    fn execute_rerand_gpu_cpu_equivalence(
        ...
        rerand_equivalence_for_shape::<FheUint64, _>(
            cks,
            cpk,
            cpu_sks,
            gpu_sks,
        ...
        rerand_equivalence_for_shape::<FheInt8, _>(
            cks,
            cpk,
            cpu_sks,
            gpu_sks,
        ...
        rerand_equivalence_for_shape::<FheBool, _>(
            cks,
            cpk,
            cpu_sks,
            gpu_sks,
    ...
    fn rerand_equivalence_for_shape<T, Clear>(
        cks: &crate::ClientKey,
        cpk: &CompactPublicKey,
        cpu_sks: &crate::ServerKey,
        gpu_sks: &crate::CudaServerKey,
