...
impl From<XofGenerationParams> for AesCtrParams {
    fn from(val: XofGenerationParams) -> Self {
        ...
        match mode {
            ...
            #[allow(deprecated)]
            XofDerivationMode::LegacyAes128FirstByte => Self {
...
impl CompressedXofKeySet {
    ...
    pub fn generate(
        ...
        derivation_mode: XofDerivationMode,
        security_bits: u32,
    ...
    pub fn generate_with_separators(
        ...
        let derivation_mode = private_seed.mode;
        ...
        let public_seed = XofGenerationParams {
            seed: XofSeed::new(public_seed_bytes, public_seed_separator),
            mode: derivation_mode,
        };
