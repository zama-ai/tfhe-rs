...
pub struct OneTimePadFheSecretMaskVersionOwned {
    pub(in crate::high_level_api) key:
        <ShortintOneTimePadFheSecretMask as VersionizeOwned>::VersionedOwned,
    pub(in crate::high_level_api) tag: <Tag as VersionizeOwned>::VersionedOwned,
}
