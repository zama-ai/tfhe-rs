...
fn scalar_add_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
...
fn scalar_sub_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
...
fn scalar_mul_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
...
fn scalar_bitand_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_bitor_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_bitxor_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_shl_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_shr_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_rotate_left_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_rotate_right_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_div_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    Clear: DecomposableInto<u8> + Reciprocable,
{
    global_state::with_internal_keys(|key| match key {
        InternalServerKey::Cpu(cpu_key) => {
            let inner_result = cpu_key
        ...
        InternalServerKey::Cuda(cuda_key) => {
            let inner_result = with_thread_local_cuda_streams(|streams| {
                cuda_key
                    .key
                    .key
                    .scalar_div(&lhs.ciphertext.on_gpu(streams), rhs, streams)
            });
            RadixCiphertext::Cuda(inner_result)
        }
    })
...
fn scalar_rem_impl<Id, Clear>(lhs: &FheUint<Id>, rhs: Clear) -> RadixCiphertext
where
    Id: FheUintId,
    Clear: DecomposableInto<u8> + Reciprocable + ScalarMultiplier,
{
    global_state::with_internal_keys(|key| match key {
        InternalServerKey::Cpu(cpu_key) => {
            let inner_result = cpu_key
        ...
        InternalServerKey::Cuda(cuda_key) => {
            let inner_result = with_thread_local_cuda_streams(|streams| {
                cuda_key
                    .key
                    .key
                    .scalar_rem(&lhs.ciphertext.on_gpu(streams), rhs, streams)
            });
            RadixCiphertext::Cuda(inner_result)
        }
    })
...
fn scalar_left_sub_impl<Id, Clear>(lhs: Clear, rhs: &FheUint<Id>) -> RadixCiphertext
where
    Id: FheUintId,
    Clear: DecomposableInto<u64>,
{
    global_state::with_internal_keys(|key| match key {
        ...
        InternalServerKey::Cuda(cuda_key) => with_thread_local_cuda_streams(|streams| {
            ...
            cuda_key
                .key
                .key
                .sub_assign(&mut result, &rhs.ciphertext.on_gpu(streams), streams);
...
fn scalar_add_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_sub_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8> + TwosComplementNegation,
{
...
fn scalar_mul_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8> + ScalarMultiplier,
{
...
fn scalar_bitand_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_bitor_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_bitxor_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8>,
{
...
fn scalar_shl_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_shr_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_rotate_left_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_rotate_right_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    u64: CastFrom<Clear>,
{
...
fn scalar_div_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8> + Reciprocable,
{
...
fn scalar_rem_assign_impl<Id, Clear>(lhs: &mut FheUint<Id>, rhs: Clear)
where
    Id: FheUintId,
    Clear: DecomposableInto<u8> + ScalarMultiplier + Reciprocable,
{
    global_state::with_internal_keys(|key| match key {
        InternalServerKey::Cpu(cpu_key) => {
            cpu_key
