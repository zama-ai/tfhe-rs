...
use crate::{
    ClientKey, CompactFheUint32, CompactFheUint32ConformanceParams, CompactFheUint32List,
    CompactFheUint32ListConformanceParams, CompactPublicKey, CompressedFheUint16,
    CompressedFheUint256, CompressedFheUint32, CompressedFheUint32ConformanceParams,
...
fn test_safe_deserialize_conformant_compact_fhe_uint32() {
    ...
    let params = CompactFheUint32ConformanceParams::from(&server_key);
    let deserialized_a =
    ...
    assert!(deserialized_a.is_conformant(&CompactFheUint32ConformanceParams::from(block_params)));
}
