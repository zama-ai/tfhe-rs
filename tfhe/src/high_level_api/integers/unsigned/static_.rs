...
use crate::high_level_api::integers::unsigned::compact::{
    CompactFheUint, CompactFheUintConformanceParams, CompactFheUintList,
    CompactFheUintListConformanceParams,
};
...
macro_rules! static_int_type {
    ...
    (
        ...
        ::paste::paste! {
            ...
            #[cfg_attr(all(doc, not(doctest)), cfg(feature = "integer"))]
            pub type [<Compressed FheUint $num_bits ConformanceParams>] = CompressedFheUintConformanceParams<[<FheUint $num_bits Id>]>;

            #[cfg_attr(all(doc, not(doctest)), cfg(feature = "integer"))]
            pub type [<Compact FheUint $num_bits ConformanceParams>] = CompactFheUintConformanceParams<[<FheUint $num_bits Id>]>;
