...
use crate::{
    generate_keys, set_server_key, ClientKey, CompactFheInt32, CompactFheInt32ConformanceParams,
    CompactFheInt32List, CompactFheInt32ListConformanceParams, CompactPublicKey,
    CompressedFheInt16, CompressedFheInt32, CompressedFheInt32ConformanceParams, Config,
    ConfigBuilder, FheInt16, FheInt256, FheInt32, FheInt32ConformanceParams, FheInt64, FheInt8,
    FheUint64, FheUint8,
};
use rand::prelude::*;
...
fn test_safe_deserialize_conformant_compact_fhe_int32() {
    ...
    let params = CompactFheInt32ConformanceParams::from(&server_key);
    let deserialized_a =
    ...
    let params = CompactFheInt32ConformanceParams::from(block_params);
    assert!(deserialized_a.is_conformant(&params));
}
