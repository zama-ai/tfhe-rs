...
fn test_case_integer_casting(cks: &ClientKey) {
    ...
    for clear in [rng.random_range(i16::MIN..0), rng.random_range(0..=i16::MAX)] {
...
fn test_case_abs(cks: &ClientKey) {
    ...
    for clear in [rng.random_range(i64::MIN..0), rng.random_range(0..=i64::MAX)] {
...
fn test_case_min_max(cks: &ClientKey) {
    let mut rng = rand::rng();
    let a_val: i8 = rng.random();
    let b_val: i8 = rng.random();
