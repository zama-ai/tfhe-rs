...
pub enum CudaDynamicAtomicPatternKeySwitchingKey {
...
pub struct CudaServerKey {
    pub key_switching_key: CudaDynamicAtomicPatternKeySwitchingKey,
...
impl CudaServerKey {
    ...
    pub(crate) fn new_server_key_with_max_degree(
        ...
        Self {
            key_switching_key: CudaDynamicAtomicPatternKeySwitchingKey::Standard(
                d_key_switching_key,
            ),
    ...
    pub fn decompress_from_cpu(
        ...
        match compressed_ap_server_key {
            ...
            CompressedAtomicPatternServerKey::KeySwitch32(ks32_key) => {
                ...
                Self {
                    key_switching_key: CudaDynamicAtomicPatternKeySwitchingKey::KeySwitch32(
                        key_switching_key,
                    ),
                    bootstrapping_key,
                    message_modulus,
