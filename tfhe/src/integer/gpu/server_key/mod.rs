...
pub enum CudaAtomicPatternKeySwitchingKey {
...
pub struct CudaServerKey {
    pub key_switching_key: CudaAtomicPatternKeySwitchingKey,
...
impl CudaServerKey {
    ...
    pub(crate) fn new_server_key_with_max_degree(
        ...
        Self {
            key_switching_key: CudaAtomicPatternKeySwitchingKey::Standard(d_key_switching_key),
    ...
    pub fn decompress_from_cpu(
        ...
        match compressed_ap_server_key {
            CompressedAtomicPatternServerKey::Standard(std_key) => {
                ...
                Self {
                    key_switching_key: CudaAtomicPatternKeySwitchingKey::Standard(
                        key_switching_key,
                    ),
                    bootstrapping_key,
                    message_modulus,
            ...
            CompressedAtomicPatternServerKey::KeySwitch32(ks32_key) => {
                let (key_switching_key, bootstrapping_key) = ks32_key.into_raw_parts();
                ...
                Self {
                    key_switching_key: CudaAtomicPatternKeySwitchingKey::KeySwitch32(
                        key_switching_key,
                    ),
                    bootstrapping_key,
                    message_modulus,
