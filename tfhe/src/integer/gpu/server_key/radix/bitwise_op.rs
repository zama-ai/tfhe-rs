...
use crate::integer::gpu::server_key::{CudaAtomicPatternKeySwitchingKey, CudaBootstrappingKey};
...
impl CudaServerKey {
    ...
    pub fn boolean_bitnot_assign(&self, ct: &mut CudaBooleanBlock, streams: &CudaStreams) {
        self.cuda_boolean_bitnot_assign(ct, false, streams);
    }
    ...
    pub fn boolean_bitand_assign(
        ...
        self.boolean_bitop_assign(ct_left, ct_right, BitOpType::And, false, streams);
    }
    ...
    pub fn boolean_bitor_assign(
        ...
        self.boolean_bitop_assign(ct_left, ct_right, BitOpType::Or, false, streams);
    }
    ...
    pub fn boolean_bitxor_assign(
        ...
        self.boolean_bitop_assign(ct_left, ct_right, BitOpType::Xor, false, streams);
    }

    pub fn boolean_bitop_assign(
        &self,
        ct_left: &mut CudaBooleanBlock,
        ct_right: &CudaBooleanBlock,
        op: BitOpType,
        ...
        let CudaAtomicPatternKeySwitchingKey::Standard(computing_ks_key) = &self.key_switching_key
        else {
    ...
    pub fn unchecked_boolean_bitnot_assign(
        ...
        self.cuda_boolean_bitnot_assign(ct, true, streams);
    }

    fn cuda_boolean_bitnot_assign(
        &self,
        ct: &mut CudaBooleanBlock,
        is_unchecked: bool,
        streams: &CudaStreams,
