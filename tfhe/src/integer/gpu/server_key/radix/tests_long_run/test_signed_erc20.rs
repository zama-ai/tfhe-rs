...
use crate::integer::server_key::radix_parallel::tests_long_run::test_signed_erc20::{
    signed_no_cmux_erc20_test, signed_safe_erc20_test, signed_whitepaper_erc20_test,
};
use crate::shortint::parameters::*;

create_gpu_parameterized_test!(signed_safe_erc20 {
...
fn signed_safe_erc20<P>(param: P)
where
