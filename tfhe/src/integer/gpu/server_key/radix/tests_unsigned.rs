...
use crate::integer::gpu::ciphertext::{CudaIntegerRadixCiphertext, CudaRadixCiphertext, CudaUnsignedRadixCiphertext};
    ...
    P: Into<PBSParameters> + Copy,
{
    ...
    for _ in 0..NB_TEST {
        ...
        let d_ctxt_1 = CudaUnsignedRadixCiphertext{
            ciphertext: CudaRadixCiphertext::from_radix_ciphertext(&ctxt_1, &stream)
        };
        let d_ctxt_2 = CudaUnsignedRadixCiphertext{
            ciphertext: CudaRadixCiphertext::from_radix_ciphertext(&ctxt_2, &stream)
        };
    ...
    P: Into<PBSParameters> + Copy,
{
    ...
    for _ in 0..NB_TEST {
        ...
        // Copy to the GPU
        let d_ctxt_1 = <CudaUnsignedRadixCiphertext as CudaIntegerRadixCiphertext>::from(CudaRadixCiphertext::from_radix_ciphertext(&ctxt_1, &stream));
        let d_ctxt_2 = <CudaUnsignedRadixCiphertext as CudaIntegerRadixCiphertext>::from(CudaRadixCiphertext::from_radix_ciphertext(&ctxt_2, &stream));
...
fn integer_unchecked_scalar_left_shift<P, Scalar, T>(param: P)
where
    P: Into<PBSParameters> + Copy,
    Scalar: CastFrom<u32>,
    u32: CastFrom<Scalar>,
...
fn integer_unchecked_scalar_right_shift<P, Scalar, T>(param: P)
where
    P: Into<PBSParameters> + Copy,
    Scalar: CastFrom<u32>,
    u32: CastFrom<Scalar>,
...
fn integer_scalar_right_shift<P, Scalar, T>(param: P)
where
    P: Into<PBSParameters> + Copy,
    Scalar: CastFrom<u32>,
    u32: CastFrom<Scalar>,
...
fn integer_scalar_left_shift<P, Scalar, T>(param: P)
where
    P: Into<PBSParameters> + Copy,
    Scalar: CastFrom<u32>,
    u32: CastFrom<Scalar>,
