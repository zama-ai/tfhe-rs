...
impl CudaServerKey {
        ...
        T: CudaIntegerRadixCiphertext,
    {
        if scalar < Scalar::ZERO {
            ...
            return CudaBooleanBlock::new_unchecked(
        ...
        let mut result = CudaBooleanBlock::new_unchecked(block, ct_info);
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn unchecked_scalar_gt_async<Scalar>(
        &self,
    ...
    pub fn unchecked_scalar_gt<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn unchecked_scalar_ge_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    pub fn unchecked_scalar_ge<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn unchecked_scalar_lt_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    pub fn unchecked_scalar_lt<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn unchecked_scalar_le_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    pub fn unchecked_scalar_le<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn scalar_gt_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn scalar_ge_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn scalar_lt_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn scalar_le_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn unchecked_scalar_max_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    pub fn unchecked_scalar_max<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn scalar_max_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
    ...
    /// - `stream` __must__ be synchronized to guarantee computation has finished, and inputs must
    ///   not be dropped until stream is synchronised
    pub unsafe fn scalar_min_async<Scalar>(
        &self,
        ct: &CudaUnsignedRadixCiphertext,
        scalar: Scalar,
        stream: &CudaStream,
