...
// Runs one sample of the pattern br rerand dp ks ms on GPU and returns
// The pattern performs blind rotation, re-randomization, scalar multiplication, key switching,
// and modulus switching in sequence, and the test checks the validity of the
...
// The test uses the templarized format developed for the CPU tests, cuda side resources is used
