...
use crate::integer::gpu::server_key::radix::tests_noise_distribution::utils::noise_simulation::{
    cuda_glwe_list_to_glwe_ciphertext, CudaPackingKeyswitchKey64,
};
...
fn sanity_check_encrypt_br_dp_packing_ks_ms(meta_params: MetaParameters) {
    ...
    let cuda_packing_key = CudaPackingKeyswitchKey64::new(&cuda_compression_key);
...
fn noise_check_encrypt_br_dp_packing_ks_ms_noise_gpu(meta_params: MetaParameters) {
    ...
    let sample_count_per_msg = 100usize;
    let chunk_size = 8;
