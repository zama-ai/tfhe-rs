...
macro_rules! define_gpu_comparison_test_functions {
    ($comparison_name:ident, $clear_type:ty) => {
        ::paste::paste!{
            ...
            fn [<integer_default_ $comparison_name _ $clear_type:lower>]<P>(param: P) where P: Into<AtomicPatternParameters> {
                let num_tests = 1;
            ...
            fn [<multi_device_integer_default_ $comparison_name _ $clear_type:lower>]<P>(param: P) where P: Into<AtomicPatternParameters> {
                let num_tests = 1;
