...
fn prepare_cuda_radix_ffi(
    ...
    CudaRadixCiphertextFFI {
        ...
        ptr: input.d_blocks.0.d_vec.get_mut_c_ptr(0).cast::<u64>(),
...
fn prepare_cuda_radix_ffi_from_slice<T: UnsignedInteger>(
    ...
    assert!(TypeId::of::<T>() == TypeId::of::<u64>());
    CudaRadixCiphertextFFI {
        _phantom_0: PhantomData,
        ptr: input.ptrs[0].cast_mut().cast::<u64>(),
        degrees: degrees_vec.as_mut_ptr(),
        noise_levels: noise_levels_vec.as_mut_ptr(),
        num_radix_blocks,
...
fn prepare_cuda_radix_ffi_128_from_slice_mut<T: UnsignedInteger>(
    input: &CudaSliceMut<T>,
    degrees_vec: &mut Vec<u64>,
    noise_levels_vec: &mut Vec<u64>,
    num_radix_blocks: u32,
    lwe_dimension: u32,
) -> CudaRadixCiphertextFFI128 {
    //u64 for most ciphertexts
    //u128 for noise squashing output
    assert!(TypeId::of::<T>() == TypeId::of::<u128>());

    CudaRadixCiphertextFFI128 {
        _phantom_0: PhantomData,
        ptr: input.ptrs[0].cast::<u128>(),
        degrees: degrees_vec.as_mut_ptr(),
        noise_levels: noise_levels_vec.as_mut_ptr(),
        num_radix_blocks,
        max_num_radix_blocks: num_radix_blocks,
...
>(
    ...
    if TypeId::of::<KST>() == TypeId::of::<u32>() {
        scratch_cuda_integer_scalar_mul_64_ks32(
            streams.ffi(),
        ...
        cuda_scalar_multiplication_ciphertext_64_ks32_inplace(
            streams.ffi(),
            &raw mut cuda_ffi_lwe_array,
...
>(
    ...
    if TypeId::of::<T>() == TypeId::of::<u64>() {
        ...
        scratch_cuda_sub_and_propagate_single_carry_64_ks32_inplace(
            streams.ffi(),
            std::ptr::addr_of_mut!(mem_ptr),
            glwe_dimension.0 as u32,
            polynomial_size.0 as u32,
        ...
        cuda_sub_and_propagate_single_carry_64_ks32_inplace(
            streams.ffi(),
            &raw mut cuda_ffi_lhs_input,
            &raw const cuda_ffi_rhs_input,
            &raw mut cuda_ffi_carry_out,
...
>(
    ...
    if TypeId::of::<T>() == TypeId::of::<u32>() {
        scratch_cuda_add_and_propagate_single_carry_64_ks32_inplace(
            streams.ffi(),
            std::ptr::addr_of_mut!(mem_ptr),
            glwe_dimension.0 as u32,
            polynomial_size.0 as u32,
        ...
        cuda_add_and_propagate_single_carry_64_ks32_inplace(
            streams.ffi(),
            &raw mut cuda_ffi_lhs_input,
            &raw const cuda_ffi_rhs_input,
            &raw mut cuda_ffi_carry_out,
...
>(
    ...
    if TypeId::of::<T>() == TypeId::of::<u32>() {
        scratch_cuda_logical_scalar_shift_64_ks32(
            streams.ffi(),
            std::ptr::addr_of_mut!(mem_ptr),
            glwe_dimension.0 as u32,
            polynomial_size.0 as u32,
        ...
        cuda_logical_scalar_shift_64_ks32_inplace(
            streams.ffi(),
            &raw mut cuda_ffi_radix_lwe_left,
            shift,
            mem_ptr,
...
pub(crate) unsafe fn cuda_backend_unchecked_div_rem_assign<T: UnsignedInteger, B: Numeric>(
    ...
    if TypeId::of::<T>() == TypeId::of::<u64>() {
        ...
        scratch_cuda_integer_div_rem_radix_ciphertext_64_ks32(
            streams.ffi(),
            is_signed,
            std::ptr::addr_of_mut!(mem_ptr),
            glwe_dimension.0 as u32,
        ...
        cuda_integer_div_rem_radix_ciphertext_64_ks32(
            streams.ffi(),
            &raw mut cuda_ffi_quotient,
            &raw mut cuda_ffi_remainder,
            &raw const cuda_ffi_numerator,
        ...
        panic!("Unsupported KS data type");
    }
...
>(
    ...
    let mut mem_ptr: *mut i8 = std::ptr::null_mut();
    let mut cuda_ffi_output = prepare_cuda_radix_ffi_128_from_slice_mut(
        output,
        output_degrees,
        output_noise_levels,
        num_blocks,
