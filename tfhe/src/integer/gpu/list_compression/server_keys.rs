...
impl CudaCompressionKey {
    ...
    pub fn compress_ciphertexts_into_list(
        ...
        let glwe_ciphertext_size =
            glwe_ciphertext_size(compress_glwe_size, compress_polynomial_size);
        // The number of u64 (both mask and bodies)
        let uncompressed_len = num_glwes * glwe_ciphertext_size + num_lwes;
        ...
        CudaPackedGlweCiphertextList {
            ...
            glwe_dimension: compress_glwe_size.to_glwe_dimension(),
            polynomial_size: compress_polynomial_size,
            message_modulus,
            carry_modulus,
            ciphertext_modulus,
