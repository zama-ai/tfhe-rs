...
use crate::integer::{BooleanBlock, IntegerKeyKind, RadixClientKey, ServerKey, SignedRadixCiphertext};
...
fn integer_signed_encrypt_decrypt_128_bits<P>(param: P)
where
...
fn integer_signed_encrypt_decrypt<P>(param: P)
where
    P: Into<PBSParameters>,
{
