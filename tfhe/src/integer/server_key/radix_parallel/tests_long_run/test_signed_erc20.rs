...
pub(crate) fn signed_safe_erc20_test<P, T1, T2, T3, T4>(
    param: P,
    ...
    >,
{
    ...
    for _ in 0..NB_TESTS_LONG_RUN {
        ...
        let decrypt_signeded_did_not_have_enough_funds: bool =
            cks.decrypt_bool(&did_not_have_enough_funds);
        let decrypt_signeded_did_not_have_enough_space: bool =
            cks.decrypt_bool(&did_not_have_enough_space);

        let did_not_have_enough_space_ct =
            SignedRadixCiphertext::from_blocks(vec![did_not_have_enough_space.0]);
        let did_not_have_enough_funds_ct =
            SignedRadixCiphertext::from_blocks(vec![did_not_have_enough_funds.0]);
        ...
        let decrypt_signeded_new_from_amount: i64 = cks.decrypt_signed(&new_from_amount);
        let decrypt_signeded_new_to_amount: i64 = cks.decrypt_signed(&new_to_amount);
        let decrypt_signeded_something_not_ok: bool = cks.decrypt_bool(&something_not_ok);
        ...
        assert_eq!(
            decrypt_signeded_did_not_have_enough_funds, expected_did_not_have_enough_funds,
        ...
        assert_eq!(
            decrypt_signeded_did_not_have_enough_space, expected_did_not_have_enough_space,
            "Invalid erc20 result on enough space: amount: {clear_amount}, to amount: {clear_to_amount}."
        );
        assert_eq!(
            decrypt_signeded_something_not_ok, expected_something_not_ok,
        ...
        assert_eq!(
            decrypt_signeded_new_from_amount, expected_new_from_amount,
        ...
        assert_eq!(
            decrypt_signeded_new_to_amount, expected_new_to_amount,
        ...
        let did_not_have_enough_space_ct_1 =
            SignedRadixCiphertext::from_blocks(vec![did_not_have_enough_space_1.0]);
        let did_not_have_enough_funds_ct_1 =
            SignedRadixCiphertext::from_blocks(vec![did_not_have_enough_funds_1.0]);
...
pub(crate) fn signed_overflow_erc20_test<P, T1, T2, T3, T4, T5>(
    param: P,
    ...
    >,
{
    ...
    for _ in 0..NB_TESTS_LONG_RUN {
        ...
        let had_enough_funds_ct = SignedRadixCiphertext::from_blocks(vec![had_enough_funds.0]);
        ...
        let had_enough_funds_ct_1 = SignedRadixCiphertext::from_blocks(vec![had_enough_funds_1.0]);
