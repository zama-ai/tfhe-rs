    ...
    >,
{
    ...
    for _ in 0..crate::integer::server_key::radix_parallel::tests_cases_unsigned::NB_TESTS_SMALLER {
    ...
    >,
{
    ...
    for i in 0..crate::integer::server_key::radix_parallel::tests_cases_unsigned::NB_TESTS_SMALLER {
        println!("i: {i}");
        let mut clear_0 = rng.gen::<u64>() % modulus;
        let clear_1 = rng.gen_range(1..modulus); // avoid division by zero
        let clear_2 = rng.gen::<u64>() % modulus;
