...
fn integer_encrypt_decrypt(param: ParametersBig) {
...
fn integer_encrypt_decrypt_128_bits(param: ParametersBig) {
    let (cks, _) = KEY_CACHE.get_from_params(param);
...
fn integer_encrypt_decrypt_128_bits_specific_values(param: ParametersBig) {
...
fn integer_encrypt_decrypt_256_bits_specific_values(param: ParametersBig) {
    let (cks, _) = KEY_CACHE.get_from_params(param);
...
fn integer_encrypt_decrypt_256_bits(param: ParametersBig) {
    let (cks, _) = KEY_CACHE.get_from_params(param);
...
fn integer_smart_add_128_bits(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_add(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_bitand(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_bitor(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_bitxor(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_blockshift(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_blockshift_right(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_negation(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_sub(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_scalar_add(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_scalar_sub(param: ParametersBig) {
    let (cks, sks) = KEY_CACHE.get_from_params(param);
...
fn integer_unchecked_scalar_decomposition_overflow(param: ParametersBig) {
