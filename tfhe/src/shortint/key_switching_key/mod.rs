...
use crate::shortint::{Ciphertext, ClientKey, DServerKey};
...
pub struct KeySwitchingKey {
    ...
    pub(crate) dest_server_key: DServerKey,
    pub(crate) src_server_key: DServerKey,
    pub cast_rshift: i8,
}
...
impl KeySwitchingKey {
    ...
    /// ```
    pub fn new(
        key_pair_1: (&ClientKey, &DServerKey),
        key_pair_2: (&ClientKey, &DServerKey),
    ...
    pub fn cast_into(&self, ct: Ciphertext, ct_dest: &mut Ciphertext) {
        match self.cast_rshift {
            ...
            i if i > 0 => {
                ...
                self.dest_server_key.apply_lookup_table_assign(ct_dest, acc);
            }
