...
use crate::core_crypto::commons::test_tools::{
    ...
    gaussian_mean_confidence_interval, gaussian_variance_confidence_interval, normality_test_f64,
    torus_modular_diff, variance,
};
...
fn noise_check_shortint_classic_pbs_atomic_pattern_noise<P: Into<AtomicPatternParameters>>(
    ...
    // let variance_ci = gaussian_variance_confidence_interval(
    //     noise_samples_after_ms.len() as f64,
