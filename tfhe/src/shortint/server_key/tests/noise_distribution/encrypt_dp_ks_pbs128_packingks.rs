...
fn dp_ks_classic_pbs128_packing_ks<
    InputCt,
    ScalarMulResult,
    KsResult,
    DriftTechniqueResult,
...
where
    ...
    // We need to be able to apply the PBS
    Bsk: ClassicFft128Bootstrap<MsResult, PbsResult, Accumulator, SideResources = Resources> + Sync,
...
fn noise_sanity_check_encrypt_dp_ks_classic_pbs128_packing_ks<P>(
    params: P,
    noise_squashing_params: NoiseSquashingParameters,
    ...
    P: Into<AtomicPatternParameters>,
{
    ...
    match &sks.atomic_pattern {
        AtomicPatternServerKey::Standard(standard_atomic_pattern_server_key) => {
            ...
            let (_before_packing, mut after_packing) = dp_ks_classic_pbs128_packing_ks(
                input_zero_as_lwe,
                max_scalar_mul,
                ksk,
                drift_key,
...
#[test]
fn test_noise_sanity_check_encrypt_dp_ks_classic_pbs128_packing_ks_test_param_message_2_carry_2_ks_pbs_tuniform_2m128(
) {
    noise_sanity_check_encrypt_dp_ks_classic_pbs128_packing_ks(
        V1_3_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        V1_3_NOISE_SQUASHING_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        V1_3_NOISE_SQUASHING_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    )
...
fn encrypt_dp_ks_classic_pbs128_packing_ks_inner_helper(
    params: AtomicPatternParameters,
    noise_squashing_params: NoiseSquashingParameters,
    noise_squashing_compression_params: NoiseSquashingCompressionParameters,
    single_cks: &ClientKey,
    ...
    let (before_packing, after_packing) = dp_ks_classic_pbs128_packing_ks(
        inputs,
        scalar_for_multiplication,
        ksk,
        drift_key,
...
fn encrypt_dp_ks_classic_pbs128_packing_ks_noise_helper(
    params: AtomicPatternParameters,
    noise_squashing_params: NoiseSquashingParameters,
    noise_squashing_compression_params: NoiseSquashingCompressionParameters,
    single_cks: &ClientKey,
    ...
    let (before_compression, after_compression) =
        encrypt_dp_ks_classic_pbs128_packing_ks_inner_helper(
            params,
            noise_squashing_params,
...
fn noise_check_encrypt_dp_ks_classic_pbs128_packing_ks_noise<P>(
    params: P,
    noise_squashing_params: NoiseSquashingParameters,
    noise_squashing_compression_params: NoiseSquashingCompressionParameters,
) where
    P: Into<AtomicPatternParameters>,
{
    ...
    let (_before_packing_sim, after_packing_sim) = {
        let noise_simulation = NoiseSimulationLwe::encrypt(&cks, 0);
        dp_ks_classic_pbs128_packing_ks(
        ...
        let current_noise_samples_after_packing: Vec<_> = (0..sample_count_per_msg)
            ...
            .map(|_| {
                let (_before_packing, after_packing) =
                    encrypt_dp_ks_classic_pbs128_packing_ks_noise_helper(
                        params,
                        noise_squashing_params,
                        noise_squashing_compression_params,
                        &cks,
...
#[test]
fn test_noise_check_encrypt_dp_ks_classic_pbs128_packing_ks_noise_param_message_2_carry_2_ks_pbs_tuniform_2m128(
) {
    noise_check_encrypt_dp_ks_classic_pbs128_packing_ks_noise(
        V1_3_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        V1_3_NOISE_SQUASHING_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        V1_3_NOISE_SQUASHING_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    )
