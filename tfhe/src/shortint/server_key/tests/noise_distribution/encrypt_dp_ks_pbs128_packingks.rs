...
use crate::shortint::parameters::{
    AtomicPatternParameters, CarryModulus, NoiseSquashingCompressionParameters,
};
...
where
    ...
    PackingKey: AllocatePackingKeyswitchResult<Output = PackingResult, SideResources = Resources>
        + LwePackingKeyswitch<[PbsResult], PackingResult, SideResources = Resources>,
    Resources: Send,
    ScalarMulResult: Send,
    KsResult: Send,
    DriftTechniqueResult: Send,
    MsResult: Send,
    PbsResult: Clone + Send,
