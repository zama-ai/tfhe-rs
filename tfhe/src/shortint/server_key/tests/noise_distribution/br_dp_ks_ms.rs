...
use crate::core_crypto::commons::noise_formulas::noise_simulation::NoiseSimulationModulus;
...
where
    ...
    KsKey: AllocateLweKeyswtichResult<Output = KsResult, SideResources = Resources>
