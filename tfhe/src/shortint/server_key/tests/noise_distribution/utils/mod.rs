...
// TODO get rid of this implem with the unsafe and implement the primitive directly on relevant
// encryption keys from shortint
pub fn encrypt_new_noiseless_dyn_lwe<
    Scalar: UnsignedInteger + Encryptable<Uniform, Gaussian<f64>> + CastFrom<u64>,
    InputKeyCont: Container<Element = Scalar>,
    Gen: ByteRandomGenerator,
>(
