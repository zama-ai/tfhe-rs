...
impl<AP: AtomicPattern> GenericServerKey<AP> {
    ...
    ///```rust
    /// use tfhe::shortint::gen_keys;
    /// use tfhe::shortint::parameters::current_params::V1_3_PARAM_MESSAGE_2_CARRY_1_KS_PBS_GAUSSIAN_2M128;
    ///
    /// // Generate the client key and the server key:
    /// let (cks, sks) = gen_keys(V1_3_PARAM_MESSAGE_2_CARRY_1_KS_PBS_GAUSSIAN_2M128);
    ///
    /// let msg = 2;
    ///
    /// // Encrypt two messages:
