...
/// less noise by calling the [switch_modulus](ModulusSwitchNoiseReductionKey::switch_modulus)
/// method on the target ciphertext.
///
    ...
    InputScalar: UnsignedInteger,
{
    ...
    pub fn switch_modulus<Cont, SwitchedScalar>(
        &self,
        input: &LweCiphertext<Cont>,
        log_modulus: CiphertextModulusLog,
    ) -> LazyStandardModulusSwitchedCt<InputScalar, SwitchedScalar, Vec<InputScalar>>
    where
        ...
        Cont: Container<Element = InputScalar>,
    {
        ...
        switch_lwe_modulus(input, log_modulus)
    }
}
