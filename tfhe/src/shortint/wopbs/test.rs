...
macro_rules! create_parameterized_test{
    ...
    ($name:ident)=> {
        ...
        {
            (V1_0_PARAM_MESSAGE_1_CARRY_1_KS_PBS_GAUSSIAN_2M128, LEGACY_WOPBS_PARAM_MESSAGE_1_CARRY_1_KS_PBS),
            (V1_0_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128, LEGACY_WOPBS_PARAM_MESSAGE_2_CARRY_2_KS_PBS),
            (V1_0_PARAM_MESSAGE_3_CARRY_3_KS_PBS_GAUSSIAN_2M128, LEGACY_WOPBS_PARAM_MESSAGE_3_CARRY_3_KS_PBS),
            (V1_0_PARAM_MESSAGE_4_CARRY_4_KS_PBS_GAUSSIAN_2M128, LEGACY_WOPBS_PARAM_MESSAGE_4_CARRY_4_KS_PBS)
        });
    };
}
