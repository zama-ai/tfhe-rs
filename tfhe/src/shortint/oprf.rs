...
pub(crate) mod test {
    ...
    use crate::shortint::server_key::StandardServerKey;
    ...
    fn oprf_compare_plain_from_seed(seed: Seed, ck: &ClientKey, sk: &StandardServerKey) {
    ...
    fn oprf_test_uniformity_ci_run_filter() {
        ...
        use crate::shortint::parameters::PARAM_MESSAGE_2_CARRY_2_KS_PBS;
        let (ck, sk) = gen_keys(PARAM_MESSAGE_2_CARRY_2_KS_PBS);
        let sk = StandardServerKey::try_from(sk).unwrap();
