    ...
    InputScalar: UnsignedTorus + CastFrom<usize> + CastInto<usize>,
{
    ...
    let seeded: SeededModulusSwitched = create_random_from_seed_modulus_switched::<InputScalar>(
        seed,
        in_lwe_size,
        bootstrapping_key
            .polynomial_size()
    ...
    match bootstrapping_key {
        ...
        ShortintBootstrappingKey::MultiBit {
            ...
            let seeded_multi_bit = MultiBitSeededModulusSwitched::from_raw_parts(
                seeded,
...
pub(crate) mod test {
    use super::*;
    use crate::core_crypto::prelude::{
        decrypt_lwe_ciphertext, CastInto, LweSecretKeyView, ModulusSwitchedCt,
    };
