...
/// and so not having to carry the extra Type asociated to the modulus switched type of
...
/// [PrfSeededModulusSwitched] ass needed (ceil(bit_count/random_bits_per_blocks))
///
