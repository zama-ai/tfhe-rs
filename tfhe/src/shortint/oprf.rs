...
///   RLE example of `bit_chunk` == &[15, 14, 1] with a `random_bits_per_block` of 2: [ 8u64, 7, 2,
///   1, 1, // 15 is 8 blocks, 7 of 2 bits and 1 of 1 bit 7, 7, 2,          // 14 is 7 blocks, 7 of
///   2 bits 1, 1, 1           // 1 is 1 block, 1 of 1 bit ]
///
///
/// # Panics
///
