...
// p-fail = 2^-174.548, algorithmic cost ~ 74, 2-norm = 3
...
// p-fail = 2^-138.803, algorithmic cost ~ 238, 2-norm = 5
...
// p-fail = 2^-130.779, algorithmic cost ~ 1832, 2-norm = 9
...
// p-fail = 2^-132.248, algorithmic cost ~ 12133, 2-norm = 17
