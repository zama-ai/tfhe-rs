...
// p-fail = 2^-109.564, algorithmic cost ~ 63, 2-norm = 3
pub const V1_0_PARAM_MULTI_BIT_GROUP_2_MESSAGE_1_CARRY_1_KS_PBS_TUNIFORM_2M80:
...
pub const V1_0_PARAM_MULTI_BIT_GROUP_2_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
pub const V1_0_PARAM_MULTI_BIT_GROUP_2_MESSAGE_3_CARRY_3_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
// p-fail = 2^-81.592, algorithmic cost ~ 9564, 2-norm = 17
pub const V1_0_PARAM_MULTI_BIT_GROUP_2_MESSAGE_4_CARRY_4_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
    lwe_dimension: LweDimension(1196),
    glwe_dimension: GlweDimension(1),
...
// p-fail = 2^-109.62, algorithmic cost ~ 65, 2-norm = 3
pub const V1_0_PARAM_MULTI_BIT_GROUP_3_MESSAGE_1_CARRY_1_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
// p-fail = 2^-119.712, algorithmic cost ~ 170, 2-norm = 5
pub const V1_0_PARAM_MULTI_BIT_GROUP_3_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
// p-fail = 2^-85.263, algorithmic cost ~ 1341, 2-norm = 9
pub const V1_0_PARAM_MULTI_BIT_GROUP_3_MESSAGE_3_CARRY_3_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
pub const V1_0_PARAM_MULTI_BIT_GROUP_3_MESSAGE_4_CARRY_4_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
pub const V1_0_PARAM_MULTI_BIT_GROUP_4_MESSAGE_1_CARRY_1_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
    lwe_dimension: LweDimension(760),
    glwe_dimension: GlweDimension(1),
    polynomial_size: PolynomialSize(2048),
...
// p-fail = 2^-112.01, algorithmic cost ~ 195, 2-norm = 5
pub const V1_0_PARAM_MULTI_BIT_GROUP_4_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
    lwe_dimension: LweDimension(880),
    glwe_dimension: GlweDimension(1),
    polynomial_size: PolynomialSize(4096),
...
pub const V1_0_PARAM_MULTI_BIT_GROUP_4_MESSAGE_3_CARRY_3_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
...
pub const V1_0_PARAM_MULTI_BIT_GROUP_4_MESSAGE_4_CARRY_4_KS_PBS_TUNIFORM_2M80:
    MultiBitPBSParameters = MultiBitPBSParameters {
