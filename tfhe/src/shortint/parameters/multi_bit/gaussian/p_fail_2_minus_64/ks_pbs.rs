...
// p-fail = 2^-66.16, algorithmic cost ~ 59, 2-norm = 3
...
// p-fail = 2^-64.006, algorithmic cost ~ 82, 2-norm = 5
...
// p-fail = 2^-64.038, algorithmic cost ~ 78, 2-norm = 5
...
// p-fail = 2^-64.143, algorithmic cost ~ 91, 2-norm = 5
