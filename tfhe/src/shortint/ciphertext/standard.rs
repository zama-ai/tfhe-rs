...
impl Ciphertext {
    ...
    pub fn re_randomize_with_compact_public_key_encryption(
        ...
        let mut result = compact_public_key.re_randomize_ciphertexts(
            std::slice::from_ref(self),
            key_switching_key_material,
            seed,
        )?;

        // If rerand succeeded, we know that the vec is composed of exactly one element
...
mod tests {
    ...
    fn test_re_randomize_ciphertext_ci_run_filter() {
        ...
        for _ in 0..10 {
            ...
            let mut re_randomizer_context =
                ReRandomizationContext::new(*b"TFHE_Rrd", [], *b"TFHE_Enc");
            ...
            let re_randomized = decompressed
