...
use crate::shortint::noise_squashing::{
    ...
    SeededShortint128BootstrappingKey, Shortint128BootstrappingKey,
};
...
#[derive(VersionsDispatch)]
pub enum SeededShortint128BootstrappingKeyVersions {
    V0(SeededShortint128BootstrappingKey),
}
...
impl Upgrade<CompressedNoiseSquashingKey> for CompressedNoiseSquashingKeyV1 {
    ...
    fn upgrade(self) -> Result<CompressedNoiseSquashingKey, Self::Error> {
        ...
        let bootstrapping_key = SeededShortint128BootstrappingKey::Classic {
            bsk: bootstrapping_key,
            modulus_switch_noise_reduction_key,
        };
