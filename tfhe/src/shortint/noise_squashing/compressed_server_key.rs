...
pub struct CompressedNoiseSquashingKey {
    pub(crate) bootstrapping_key: SeededLweBootstrapKeyOwned<u128>,
    pub(crate) modulus_switch_noise_reduction_key: CompressedModulusSwitchConfiguration<u64>,
...
impl ParameterSetConformant for CompressedNoiseSquashingKey {
    ...
    fn is_conformant(&self, parameter_set: &Self::ParameterSet) -> bool {
        ...
        let modulus_switch_key_ok = match (
            ...
            (CompressedModulusSwitchConfiguration::Standard, ModulusSwitchType::Standard) => true,
            (
