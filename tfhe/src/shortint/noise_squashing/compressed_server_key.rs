...
use crate::shortint::parameters::{
    CarryModulus, CoreCiphertextModulus, MessageModulus, ModSwitchType,
};
...
impl CompressedNoiseSquashingKey {
    ...
    //     match self.modulus_switch_noise_reduction_key.as_ref()
    // }
}
impl ClientKey {
...
impl CompressedNoiseSquashingKey {
    ...
    pub fn decompress(&self) -> NoiseSquashingKey {
        let (bootstrapping_key, modulus_switch_noise_reduction_key) = {
            ...
            (fbsk, self.modulus_switch_noise_reduction_key.decompress())
        };
...
impl ParameterSetConformant for CompressedNoiseSquashingKey {
    ...
    fn is_conformant(&self, parameter_set: &Self::ParameterSet) -> bool {
        ...
        let modulus_switch_key_ok = match (
            ...
            (CompressedModulusSwitchConfiguration::Centered, ModSwitchType::Centered) => true,
            (
                CompressedModulusSwitchConfiguration::PlainAddZero(key),
