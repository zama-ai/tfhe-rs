...
use crate::shortint::parameters::{
    CarryModulus, CoreCiphertextModulus, MessageModulus, ModSwitchType, PBSOrder, PBSParameters,
};
...
pub struct NoiseSquashingKey {
    ...
    pub(super) modulus_switch_noise_reduction_key: ModulusSwitchConfiguration<u64>,
...
impl ParameterSetConformant for NoiseSquashingKey {
    ...
    fn is_conformant(&self, parameter_set: &Self::ParameterSet) -> bool {
        ...
        let modulus_switch_key_ok = match (
            ...
            (ModulusSwitchConfiguration::Plain, ModSwitchType::Plain) => true,
            (ModulusSwitchConfiguration::Centered, ModSwitchType::Centered) => true,
            (
                ModulusSwitchConfiguration::PlainAddZero(key),
                ModSwitchType::PlainAddZero(params),
            ) => {
