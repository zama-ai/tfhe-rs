...
use crate::core_crypto::commons::math::random::{DefaultRandomGenerator, RandomGenerator, XofSeed};
...
fn noise_generator_from_seed(
    ...
    let random_generator = RandomGenerator::<DefaultRandomGenerator>::new(xof_seed);
    Ok(NoiseRandomGenerator::from_raw_parts(random_generator))
}
