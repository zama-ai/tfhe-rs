...
impl_safe_deserialize_conformant_integer!(FheBool);
...
impl_safe_deserialize_conformant_integer!(CompressedFheBool);
...
impl_safe_deserialize_conformant_integer!(CompactFheBool);
