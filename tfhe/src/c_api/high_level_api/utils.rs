        ...
        ::paste::paste! {
            ...
            pub unsafe extern "C" fn [<$wrapper_type:snake _safe_serialize>](
                ...
                crate::c_api::utils::catch_panic(|| {
                    ...
                    tfhe_safe_serialize::SerializationConfig::new(serialized_size_limit).serialize_into(&sself.0, &mut buffer)
                        .unwrap();
...
macro_rules! impl_safe_deserialize_conformant_on_type {
            ...
            pub unsafe extern "C" fn [<$wrapper_type:snake _safe_deserialize_conformant>](
                ...
                crate::c_api::utils::catch_panic(|| {
                    ...
                    *result = std::ptr::null_mut();
                    ...
                    let inner = tfhe_safe_serialize::DeserializationConfig::new(
...
pub(crate) use impl_safe_deserialize_conformant_on_type;
            ...
            pub unsafe extern "C" fn [<$wrapper_type:snake _safe_deserialize>](
                ...
                crate::c_api::utils::catch_panic(|| {
                    ...
                    *result = std::ptr::null_mut();
                    ...
                    let inner = tfhe_safe_serialize::DeserializationConfig::new(serialized_size_limit)
                    .disable_conformance()
...
pub(crate) use impl_safe_deserialize_on_type;
