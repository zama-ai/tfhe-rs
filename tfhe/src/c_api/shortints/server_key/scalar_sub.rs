...
#[no_mangle]
pub unsafe extern "C" fn shortints_server_key_smart_scalar_sub(
...
#[no_mangle]
pub unsafe extern "C" fn shortints_server_key_unchecked_scalar_sub(
    server_key: *const ShortintServerKey,
    ct_left: *mut ShortintCiphertext,
    scalar_right: u8,
    result: *mut *mut ShortintCiphertext,
...
#[no_mangle]
pub unsafe extern "C" fn shortints_server_key_smart_scalar_sub_assign(
    server_key: *const ShortintServerKey,
...
#[no_mangle]
pub unsafe extern "C" fn shortints_server_key_unchecked_scalar_sub_assign(
    server_key: *const ShortintServerKey,
    ct_left_and_result: *mut ShortintCiphertext,
    scalar_right: u8,
) -> c_int {
