...
impl_try_encrypt_with_client_key_on_type!(FheUint10{crate::typed_api::FheUint10}, u16);
impl_try_encrypt_with_public_key_on_type!(FheUint10{crate::typed_api::FheUint10}, u16);
impl_try_encrypt_with_client_key_on_type!(CompressedFheUint10{crate::typed_api::CompressedFheUint10}, u16);

impl_decrypt_on_type!(FheUint12, u16);
impl_try_encrypt_with_client_key_on_type!(FheUint12{crate::typed_api::FheUint12}, u16);
impl_try_encrypt_with_public_key_on_type!(FheUint12{crate::typed_api::FheUint12}, u16);
impl_try_encrypt_with_client_key_on_type!(CompressedFheUint12{crate::typed_api::CompressedFheUint12}, u16);

impl_decrypt_on_type!(FheUint14, u16);
impl_try_encrypt_with_client_key_on_type!(FheUint14{crate::typed_api::FheUint14}, u16);
impl_try_encrypt_with_public_key_on_type!(FheUint14{crate::typed_api::FheUint14}, u16);
impl_try_encrypt_with_client_key_on_type!(CompressedFheUint14{crate::typed_api::CompressedFheUint14}, u16);
...
impl_try_encrypt_with_client_key_on_type!(FheUint32{crate::typed_api::FheUint32}, u32);
impl_try_encrypt_with_public_key_on_type!(FheUint32{crate::typed_api::FheUint32}, u32);
impl_try_encrypt_with_client_key_on_type!(CompressedFheUint32{crate::typed_api::CompressedFheUint32}, u32);

impl_decrypt_on_type!(FheUint64, u64);
impl_try_encrypt_with_client_key_on_type!(FheUint64{crate::typed_api::FheUint64}, u64);
impl_try_encrypt_with_public_key_on_type!(FheUint64{crate::typed_api::FheUint64}, u64);
impl_try_encrypt_with_client_key_on_type!(CompressedFheUint64{crate::typed_api::CompressedFheUint64}, u64);
...
pub unsafe extern "C" fn fhe_uint128_try_encrypt_with_client_key_u128(
    ...
    catch_panic(|| {
        ...
        let inner = <crate::typed_api::FheUint128>::try_encrypt(value, &client_key.0).unwrap();
...
pub unsafe extern "C" fn compressed_fhe_uint128_try_encrypt_with_client_key_u128(
    ...
    catch_panic(|| {
        ...
        let inner =
            <crate::typed_api::CompressedFheUint128>::try_encrypt(value, &client_key.0).unwrap();
...
pub unsafe extern "C" fn fhe_uint128_try_encrypt_with_public_key_u128(
    ...
    catch_panic(|| {
        ...
        let inner = <crate::typed_api::FheUint128>::try_encrypt(value, &public_key.0).unwrap();
