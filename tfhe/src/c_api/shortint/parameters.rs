...
use crate::shortint::parameters::v1_9::*;
...
expose_as_shortint_compact_public_key_parameters!(
    ...
    (
        ...
        V1_9_PARAM_KEYSWITCH_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128
    ),
    (
...
expose_as_shortint_compression_parameters!(
    ...
    // v1.9
    V1_9_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    V1_9_COMP_PARAM_GPU_MULTI_BIT_GROUP_4_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    // v1.8
    V1_8_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
