...
impl TryFrom<ShortintPBSParameters> for crate::shortint::ClassicPBSParameters {
    ...
    fn try_from(c_params: ShortintPBSParameters) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            lwe_noise_distribution: StandardDev(c_params.lwe_modular_std_dev),
            glwe_noise_distribution: StandardDev(c_params.glwe_modular_std_dev),
...
impl ShortintPBSParameters {
    const fn convert(rust_params: crate::shortint::ClassicPBSParameters) -> Self {
        Self {
            ...
            lwe_modular_std_dev: rust_params.lwe_noise_distribution.0,
            glwe_modular_std_dev: rust_params.glwe_noise_distribution.0,
