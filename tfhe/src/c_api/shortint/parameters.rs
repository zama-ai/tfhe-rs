...
#[no_mangle]
pub unsafe extern "C" fn shortint_bc_get_parameters(
    message_bits: u32,
    carry_bits: u32,
    result: *mut *mut ShortintParameters,
) -> c_int {
    catch_panic(|| {
        check_ptr_is_non_null_and_aligned(result).unwrap();
        let params: Option<_> = match (message_bits, carry_bits) {
            (1, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_0),
            (1, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_1),
            (2, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_0),
            (1, 2) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_2),
            (2, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_1),
            (3, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_3_CARRY_0),
            (1, 3) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_3),
            (2, 2) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_2),
            (3, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_3_CARRY_1),
            (4, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_4_CARRY_0),
            (1, 4) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_4),
            (2, 3) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_3),
            (3, 2) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_3_CARRY_2),
            (4, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_4_CARRY_1),
            (5, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_5_CARRY_0),
            (1, 5) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_5),
            (2, 4) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_4),
            (3, 3) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_3_CARRY_3),
            (4, 2) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_4_CARRY_2),
            (5, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_5_CARRY_1),
            (6, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_6_CARRY_0),
            (1, 6) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_6),
            (2, 5) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_5),
            (3, 4) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_3_CARRY_4),
            (4, 3) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_4_CARRY_3),
            (5, 2) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_5_CARRY_2),
            (6, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_6_CARRY_1),
            (7, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_7_CARRY_0),
            (1, 7) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_1_CARRY_7),
            (2, 6) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_2_CARRY_6),
            (3, 5) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_3_CARRY_5),
            (4, 4) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_4_CARRY_4),
            (5, 3) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_5_CARRY_3),
            (6, 2) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_6_CARRY_2),
            (7, 1) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_7_CARRY_1),
            (8, 0) => Some(crate::shortint::parameters::bc_parameters::PARAM_MESSAGE_8_CARRY_0),
            _ => None,
        };
