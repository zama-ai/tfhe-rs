...
impl ModulusSwitchType {
    pub const fn new_plain() -> Self {
        Self {
            tag: 0,
            modulus_switch_noise_reduction_params: ModulusSwitchNoiseReductionParams::default(),
        }
    }
...
impl RustModulusSwitchType {
    const fn convert_to_c(&self) -> ModulusSwitchType {
        let modulus_switch_noise_reduction_params_default =
            ModulusSwitchNoiseReductionParams::default();

        match self {
            Self::Plain => ModulusSwitchType {
                tag: 0,
                modulus_switch_noise_reduction_params:
                    modulus_switch_noise_reduction_params_default,
            },
            Self::PlainAddZero(modulus_switch_noise_reduction_params) => ModulusSwitchType {
                tag: 1,
                modulus_switch_noise_reduction_params: modulus_switch_noise_reduction_params
                    .convert_to_c(),
            },
            Self::Centered => ModulusSwitchType {
                tag: 2,
                modulus_switch_noise_reduction_params:
                    modulus_switch_noise_reduction_params_default,
            },
