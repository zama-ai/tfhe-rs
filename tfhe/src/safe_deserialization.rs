...
mod test_integer {
    ...
    use crate::{
        CompactFheUint8, CompactFheUint8ConformanceParams, CompactFheUint8List,
        CompactFheUint8ListConformanceParams, CompactPublicKey,
    };
    #[test]
    fn safe_desererialization_ct() {
        ...
        let params = CompactFheUint8ConformanceParams::from(PARAM_MESSAGE_1_CARRY_1_KS_PBS);
        ...
        let params = CompactFheUint8ConformanceParams::from(&server_key);
        let ct2 =
    ...
    fn safe_desererialization_ct_list() {
        ...
        for param_set in [
            ...
            to_param_set(ListSizeConstraint::exact_size(3)),
