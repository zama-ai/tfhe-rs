...
async function compressedPublicKeyTest() {
  let params_name_small =
    ShortintParametersName.V1_4_PARAM_MESSAGE_2_CARRY_2_PBS_KS_GAUSSIAN_2M128;
...
async function compactPublicKeyBench32BitBig() {
  const params =
    ShortintParametersName.V1_4_PARAM_MESSAGE_2_CARRY_2_COMPACT_PK_KS_PBS_GAUSSIAN_2M128;
...
async function compactPublicKeyBench32BitSmall() {
  const params =
    ShortintParametersName.V1_4_PARAM_MESSAGE_2_CARRY_2_COMPACT_PK_PBS_KS_GAUSSIAN_2M128;
  const block_params = new ShortintParameters(params);
  let config = TfheConfigBuilder.default()
    .use_custom_parameters(block_params)
    .build();
...
async function compressedServerKeyBenchMessage1Carry1() {
  const params =
    ShortintParametersName.V1_4_PARAM_MESSAGE_1_CARRY_1_KS_PBS_GAUSSIAN_2M128;
  const block_params = new ShortintParameters(params);
  let config = TfheConfigBuilder.default()
    .use_custom_parameters(block_params)
    .build();
...
async function compressedServerKeyBenchMessage2Carry2() {
  const params =
    ShortintParametersName.V1_4_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128;
  const block_params = new ShortintParameters(params);
  let config = TfheConfigBuilder.default()
    .use_custom_parameters(block_params)
    .build();
...
async function compactPublicKeyZeroKnowledgeBench() {
  let params_to_bench = [
    ...
    },
    {
      ...
      casting_params: new ShortintCompactPublicKeyEncryptionParameters(
        ShortintCompactPublicKeyEncryptionParametersName.V1_4_PARAM_PKE_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128_ZKV1,
      ),
    },
  ];
