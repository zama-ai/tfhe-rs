...
// and not in a worker
async function compactPublicKeyZeroKnowledgeAsyncMainThreadTest() {
...
async function setup() {
  ...
  const mainThreadDemos = {
    compactPublicKeyZeroKnowledgeAsyncMainThreadTest,
  };
  ...
  if (!crossOriginIsolated) {
    ...
    await init_cross_origin_worker_pool(wasmUrl, bindgenUrl, "/sw.js", null);
