...
export async function compactPublicKeyBench32BitBig() {
...
export async function compactPublicKeyBench32BitSmall() {
  return await compactPublicKeyBench(
...
export async function compactPublicKeyBench256BitBig() {
  return await compactPublicKeyBench(
    ShortintParametersName.V1_6_PARAM_MESSAGE_2_CARRY_2_COMPACT_PK_KS_PBS_GAUSSIAN_2M128,
    "256",
  );
...
export async function compactPublicKeyBench256BitSmall() {
  return await compactPublicKeyBench(
    ShortintParametersName.V1_6_PARAM_MESSAGE_2_CARRY_2_COMPACT_PK_PBS_KS_GAUSSIAN_2M128,
    "256",
  );
