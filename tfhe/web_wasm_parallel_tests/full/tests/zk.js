...
import { get_tfhe_config_with_casting } from "../config.js";

export async function compactPublicKeyZeroKnowledgeTest() {
  ...
  // Single u64 input
  {
    ...
    console.log(`Time to encrypt + prove CompactFheUint64: ${r.timing_ms} ms`);
...
export async function asyncMainThreadCompactPublicKeyZeroKnowledgeTest() {
  const config = get_tfhe_config_with_casting(
    ShortintParametersName.PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    ShortintCompactPublicKeyEncryptionParametersName.PARAM_PKE_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
  );
