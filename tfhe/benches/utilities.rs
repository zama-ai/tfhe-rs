...
pub struct CryptoParametersRecord<Scalar: UnsignedInteger> {
    ...
    pub lwe_dimension1: Option<LweDimension>,
    pub lwe_dimension2: Option<LweDimension>,
    pub glwe_dimension: Option<GlweDimension>,
    pub glwe_dimension1: Option<GlweDimension>,
    pub glwe_dimension2: Option<GlweDimension>,
    pub glwe_dimension3: Option<GlweDimension>,
    pub polynomial_size: Option<PolynomialSize>,
    pub polynomial_size1: Option<PolynomialSize>,
    pub polynomial_size2: Option<PolynomialSize>,
    pub polynomial_size3: Option<PolynomialSize>,
    pub lwe_modular_std_dev: Option<StandardDev>,
    pub lwe_modular_std_dev1: Option<StandardDev>,
    pub lwe_modular_std_dev2: Option<StandardDev>,
    pub glwe_modular_std_dev: Option<StandardDev>,
    pub glwe_modular_std_dev1: Option<StandardDev>,
    pub glwe_modular_std_dev2: Option<StandardDev>,
    pub glwe_modular_std_dev3: Option<StandardDev>,
    ...
    pub ks_base_log1: Option<DecompositionBaseLog>,
    pub ks_level1: Option<DecompositionLevelCount>,
    pub ks_base_log2: Option<DecompositionBaseLog>,
    pub ks_level2: Option<DecompositionLevelCount>,
    ...
    pub relin_base_log: Option<DecompositionBaseLog>,
    pub relin_level: Option<DecompositionLevelCount>,
    pub packing_base_log: Option<DecompositionBaseLog>,
    pub packing_level: Option<DecompositionLevelCount>,
...
impl<Scalar: UnsignedInteger> From<BooleanParameters> for CryptoParametersRecord<Scalar> {
    fn from(params: BooleanParameters) -> Self {
        CryptoParametersRecord {
            ...
            lwe_dimension1: None,
            lwe_dimension2: None,
            glwe_dimension1: None,
            glwe_dimension2: None,
            glwe_dimension3: None,
            polynomial_size1: None,
            polynomial_size2: None,
            polynomial_size3: None,
            lwe_modular_std_dev1: None,
            lwe_modular_std_dev2: None,
            glwe_modular_std_dev1: None,
            glwe_modular_std_dev2: None,
            glwe_modular_std_dev3: None,
            ks_base_log1: None,
            ks_base_log2: None,
            ks_level1: None,
            ks_level2: None,
