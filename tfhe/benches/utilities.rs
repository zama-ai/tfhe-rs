...
pub mod shortint_utils {
    ...
    use tfhe::shortint::parameters::{ShortintKeySwitchingParameters, PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M64, V1_0_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128};
    use tfhe::shortint::{
    ...
    impl Default for ParamsAndNumBlocksIter {
        fn default() -> Self {
            ...
            if env_config.is_multi_bit {
                ...
                // operations.
                let params = vec![V1_0_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128.into()];
