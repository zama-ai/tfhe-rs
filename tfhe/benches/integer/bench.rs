...
use tfhe::integer::{
    key_switching_key::KeySwitchingKey, ClientKey, CompactPublicKey, IntegerKeyKind,
    RadixCiphertext, RadixClientKey, ServerKey, U256,
};
...
fn pke_ap(c: &mut Criterion) {
    ...
    for (param_name, param_pke, param_fhe, param_ksk) in [
        (
