...
void test_predefined_keygen_w_serde(void) {
  ...
  ShortintPBSParameters params = SHORTINT_V1_4_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128;
...
int main(void) {
  ...
  test_custom_keygen();
  test_public_keygen(SHORTINT_V1_4_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128);
  test_public_keygen(SHORTINT_V1_4_PARAM_MESSAGE_2_CARRY_2_PBS_KS_GAUSSIAN_2M128);
  test_compressed_public_keygen(SHORTINT_V1_4_PARAM_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128);
  test_compressed_public_keygen(SHORTINT_V1_4_PARAM_MESSAGE_2_CARRY_2_PBS_KS_GAUSSIAN_2M128);
