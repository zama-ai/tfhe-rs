macro_rules! impl_hlapi_showcase {
    ($fhe_type: ty, $user_type: ty) => {
        ...
        fn hlapi_showcase(
            ...
            // SHIFTS_L / SHIFTS_R / ROTS_L / ROTS_R ---------------------------
            // Shift and rotate by a *clear* amount. Shifting by the operand width or more
            // yields 0, while a rotation takes its amount modulo the width.
            let in_a = rng.gen_range(0..$user_type::MAX);
