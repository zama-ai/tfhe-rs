...
test("hlapi_proven_compact_ciphertext_list_seeded", (t) => {
  ...
  console.log(`proven seeded test — seed_a: [${Array.from(seed_a).join(", ")}], seed_b: [${Array.from(seed_b).join(", ")}]`);
...
test("hlapi_compact_ciphertext_list_seeded", (t) => {
  ...
  let seed_a = randomBytes(16);
  let seed_b = randomBytes(16);
  console.log(`seeded test — seed_a: [${Array.from(seed_a).join(", ")}], seed_b: [${Array.from(seed_b).join(", ")}]`);
