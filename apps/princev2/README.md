...
let ct_m: Box<[Ciphertext; 32]> = encrypt_u64_as_u2l(&c_key, 0x0123456789abcdef);
let ct_k0: Box<[Ciphertext; 32]> = encrypt_u64_as_u2l(&c_key, 0x0123456789abcdef);
let ct_k1: Box<[Ciphertext; 32]> = encrypt_u64_as_u2l(&c_key, 0xfedcba9876543210);

let ct_out: Box<[Ciphertext; 32]> = encrypt(&ev_key, &ct_m, &ct_k0, &ct_k1);
